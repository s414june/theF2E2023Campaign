import {
  ...
  tt,
  v
} from "./chunk-4J676R4R.js";
import "./chunk-CT64F5AA.js";
import {
  __publicField
} from "./chunk-E3EO7R6B.js";

// node_modules/@dotlottie/player-component/dist/dotlottie-state-machine-manager-EQLJDSHN-GQNUJPNH.mjs
var v2 = function() {
  return v2 = Object.assign || function(e) {
...
var Dt = P.Invoke;
P.ErrorExecution;
var Yt = P.ErrorPlatform;
var Te = P.ErrorCustom;
var ce = P.Update;
var Ne = P.Choose;
var je = P.Pure;
var ue = ".";
...
function Xt(e, t, n) {
  n === void 0 && (n = ue);
  var i = lt(e, n), r = lt(t, n);
  return A(r) ? A(i) ? r === i : false : A(i) ? i in r : Object.keys(i).every(function(o) {
    return o in r ? Xt(i[o], r[o]) : false;
  });
}
function he(e) {
  try {
...
function Tt(e) {
  if (e.length === 1)
    return e[0];
  for (var t = {}, n = t, i = 0; i < e.length - 1; i++)
    i === e.length - 2 ? n[e[i]] = e[i + 1] : (n[e[i]] = {}, n = n[e[i]]);
  return t;
}
function ct(e, t) {
...
function wt(e) {
  ...
  var t = I(Object.keys(e).map(function(n) {
    var i = e[n];
    return typeof i != "string" && (!i || !Object.keys(i).length) ? [[n]] : wt(e[n]).map(function(r) {
      return [n].concat(r);
    });
  }));
  return t;
...
function I(e) {
  var t;
  return (t = []).concat.apply(t, V([], O(e), false));
}
function fe(e) {
  return ot(e) ? e : [e];
}
...
function Me(e, t) {
  var n, i, r = O([[], []], 2), o = r[0], a = r[1];
  try {
    for (var s = E(e), c = s.next(); !c.done; c = s.next()) {
      var h = c.value;
      t(h) ? o.push(h) : a.push(h);
    }
  } catch (f) {
    n = { error: f };
  } finally {
...
function le(e, t) {
  return ct(e.states, function(n, i) {
    if (n) {
      ...
      if (r)
        return { current: r, states: le(n, r) };
    }
  });
}
function De(e, t) {
  return { current: t, states: le(e, t) };
}
function ne(e, t, n, i) {
  var r = e && n.reduce(function(o, a) {
    var s, c, h = a.assignment, f = { state: i, action: a, _event: t }, d = {};
    if (T(h))
      d = h(o, t.data, f);
    else
      try {
        for (var u = E(Object.keys(h)), l = u.next(); !l.done; l = u.next()) {
          var y = l.value, p = h[y];
          d[y] = T(p) ? p(o, t.data, f) : p;
        }
      } catch (b) {
        s = { error: b };
      } finally {
...
function de(e, t) {
  if (e)
    return A(e) ? { type: Rt, name: e, predicate: t ? t[e] : void 0 } : T(e) ? { type: Rt, name: e.name, predicate: e } : e;
}
function ze(e) {
  try {
...
function Lt(e, t) {
  return A(e) || typeof e == "number" ? v2({ type: e }, t) : e;
}
function R(e, t) {
  if (!A(e) && "$$type" in e && e.$$type === "scxml")
    return e;
  var n = Lt(e);
  return v2({ name: n.type, data: n, $$type: "scxml", type: "external" }, t);
}
function Z(e, t) {
  var n = fe(t).map(function(i) {
    return typeof i > "u" || typeof i == "string" || rt(i) ? { target: i, event: e } : v2(v2({}, i), { event: e });
  });
  return n;
}
function Je(e) {
...
function ve(e, t, n, i, r) {
  var o = e.options.guards, a = { state: r, cond: t, _event: i };
  if (t.type === Rt)
    return ((o == null ? void 0 : o[t.name]) || t.predicate)(n, i.data, a);
...
function Et(e, t, n) {
  var i = function() {
  }, r = typeof e == "object", o = r ? e : null;
  return { next: ((r ? e.next : e) || i).bind(o), error: ((r ? e.error : t) || i).bind(o), complete: ((r ? e.complete : n) || i).bind(o) };
}
function _t(e, t) {
...
function dt(e, t) {
  ...
  if (A(e) || typeof e == "number") {
    var i = Jt(e, t);
    T(i) ? n = { type: e, exec: i } : i ? n = i : n = { type: e, exec: void 0 };
  } else if (T(e))
    n = { type: e.name || e.toString(), exec: e };
  else {
    var i = Jt(e.type, t);
    if (T(i))
      n = v2(v2({}, e), { exec: i });
...
function Qt(e) {
  var t = dt(e);
  return v2(v2({ id: A(e) ? e : t.id }, t), { type: t.type });
}
function qe(e, t) {
  return { type: pt, event: typeof e == "function" ? e : Lt(e), delay: t ? t.delay : void 0, id: t == null ? void 0 : t.id };
}
function Ue(e, t, n, i) {
  var r = { _event: n }, o = R(T(e.event) ? e.event(t, n.data, r) : e.event), a;
  if (A(e.delay)) {
    var s = i && i[e.delay];
    a = T(s) ? s(t, n.data, r) : s;
  } else
    a = T(e.delay) ? e.delay(t, n.data, r) : e.delay;
  return v2(v2({}, e), { type: pt, _event: o, delay: a });
}
function $e(e, t) {
  return { to: t ? t.to : void 0, type: Pt, event: T(e) ? e : Lt(e), delay: t ? t.delay : void 0, id: t && t.id !== void 0 ? t.id : T(e) ? e.name : he(e) };
}
function Fe(e, t, n, i) {
  var r = { _event: n }, o = R(T(e.event) ? e.event(t, n.data, r) : e.event), a;
  if (A(e.delay)) {
  ...
  return v2(v2({}, e), { to: c, _event: o, event: o.data, delay: a });
}
var Xe = function(e, t, n) {
  return v2(v2({}, e), { value: A(e.expr) ? e.expr : e.expr(t, n.data, { _event: n }) });
};
var Qe = function(e) {
  return { type: oe, sendId: e };
};
function He(e) {
  var t = Qt(e);
  return { type: P.Start, activity: t, exec: void 0 };
}
function We(e) {
  var t = T(e) ? e : Qt(e);
  return { type: P.Stop, activity: t, exec: void 0 };
}
function Ke(e, t, n) {
  var i = T(e.activity) ? e.activity(t, n.data) : e.activity, r = typeof i == "string" ? { id: i } : i, o = { type: P.Stop, activity: r };
  return o;
}
function Ze(e, t) {
  var n = t ? "#".concat(t) : "";
...
function bt(e, t) {
  var n = "".concat(P.DoneState, ".").concat(e), i = { type: n, data: t };
  return i.toString = function() {
    return n;
  }, i;
}
function Ot(e, t) {
  var n = "".concat(P.DoneInvoke, ".").concat(e), i = { type: n, data: t };
  return i.toString = function() {
    return n;
  }, i;
}
function ut(e, t) {
  var n = "".concat(P.ErrorPlatform, ".").concat(e), i = { type: n, data: t };
  return i.toString = function() {
    return n;
  }, i;
}
...
function jt(e, t, n, i, r, o, a) {
  a === void 0 && (a = false);
  var s = a ? [] : Ye(r), c = s.length ? ne(n, i, s, t) : n, h = a ? [n] : void 0, f = [];
  function d(y, p) {
    var b;
    switch (p.type) {
      case pt: {
        var g = Ue(p, c, i, e.options.delays);
        return o && typeof g.delay == "number" && o(g, c, i), g;
      }
      case Pt:
        var m = Fe(p, c, i, e.options.delays);
        return o && m.to !== it.Internal && (y === "entry" ? f.push(m) : o(m, c, i)), m;
      case se: {
        var _ = Xe(p, c, i);
        return o == null ? void 0 : o(_, c, i), _;
      }
      case Ne: {
        var S = p, N = (b = S.conds.find(function(yt) {
          var $ = de(yt.cond, e.options.guards);
          return !$ || ve(e, $, c, i, o ? void 0 : t);
        })) === null || b === void 0 ? void 0 : b.actions;
        if (!N)
          return [];
        var C = O(jt(e, t, c, i, [{ type: y, actions: Q(U(N), e.options.actions) }], o, a), 2), k = C[0], L = C[1];
        return c = L, h == null ? void 0 : h.push(c), k;
      }
      case je: {
        var N = p.get(c, i.data);
        if (!N)
          return [];
        var w = O(jt(e, t, c, i, [{ type: y, actions: Q(U(N), e.options.actions) }], o, a), 2), M = w[0], x = w[1];
        return c = x, h == null ? void 0 : h.push(c), M;
      }
      case Ft: {
        var _ = Ke(p, c, i);
        return o == null ? void 0 : o(_, n, i), _;
      }
      case ae: {
        c = ne(c, i, [p], o ? void 0 : t), h == null ? void 0 : h.push(c);
        break;
      }
      default:
        var j = dt(p, e.options.actions), z = j.exec;
        if (o)
          o(j, c, i);
        else if (z && h) {
          var B = h.length - 1, at = v2(v2({}, j), { exec: function(yt) {
            for (var $ = [], H = 1; H < arguments.length; H++)
              $[H - 1] = arguments[H];
            z.apply(void 0, V([h[B]], O($), false));
          } });
          j = at;
        }
        return j;
  ...
  function u(y) {
    var p, b, g = [];
    try {
      for (var m = E(y.actions), _ = m.next(); !_.done; _ = m.next()) {
        var S = _.value, N = d(y.type, S);
        N && (g = g.concat(N));
      }
    } catch (C) {
      p = { error: C };
...
function ge(e, t, n) {
  var i = ye(t);
  if (i.deferred = true, rt(e)) {
    var r = i.state = tt2(void 0, function() {
...
function nn2(e) {
  var t;
  return v2((t = { subscribe: function() {
    return { unsubscribe: function() {
    } };
...
function ht(e, t) {
  var n, i, r, o, a, s, c, h, f = new Set(e), d = qt(f), u = new Set(t);
  try {
    for (var l = E(u), y = l.next(); !y.done; y = l.next())
      for (var p = y.value, b = p.parent; b && !u.has(b); )
        u.add(b), b = b.parent;
  } catch (w) {
    n = { error: w };
  } finally {
    try {
      y && !y.done && (i = l.return) && i.call(l);
    } finally {
      if (n)
        throw n.error;
    }
  ...
  var g = qt(u);
  try {
    for (var m = E(u), _ = m.next(); !_.done; _ = m.next()) {
      var p = _.value;
      if (p.type === "compound" && (!g.get(p) || !g.get(p).length))
        d.get(p) ? d.get(p).forEach(function(M) {
          return u.add(M);
        }) : p.initialStateNodes.forEach(function(M) {
          return u.add(M);
        });
      else if (p.type === "parallel")
        try {
          for (var S = (a = void 0, E(vt(p))), N = S.next(); !N.done; N = S.next()) {
            var C = N.value;
            u.has(C) || (u.add(C), d.get(C) ? d.get(C).forEach(function(M) {
              return u.add(M);
  ...
  try {
    for (var k = E(u), L = k.next(); !L.done; L = k.next())
      for (var p = L.value, b = p.parent; b && !u.has(b); )
        u.add(b), b = b.parent;
  } catch (w) {
    c = { error: w };
  } finally {
...
function cn(e, t) {
  var n = e.exec, i = v2(v2({}, e), { exec: n !== void 0 ? function() {
...
var F2 = function() {
  ...
  return e.from = function(t, n) {
    if (t instanceof e)
      return t.context !== n ? new e({ value: t.value, context: n, _event: t._event, _sessionid: null, historyValue: t.historyValue, history: t.history, actions: [], activities: t.activities, meta: {}, events: [], configuration: [], transitions: [], children: {} }) : t;
    var i = nt;
    return new e({ value: t, context: n, _event: i, _sessionid: null, historyValue: void 0, history: void 0, actions: [], activities: void 0, meta: void 0, events: [], configuration: [], transitions: [], children: {} });
  }, e.create = function(t) {
    return new e(t);
    ...
    if (t instanceof e) {
      if (!t.actions.length)
        return t;
      var i = nt;
      return new e({ value: t.value, context: n, _event: i, _sessionid: null, historyValue: t.historyValue, history: t.history, activities: t.activities, configuration: t.configuration, transitions: [], children: {} });
    }
    return e.from(t, n);
  }, e.prototype.toStrings = function(t, n) {
    var i = this;
    if (t === void 0 && (t = this.value), n === void 0 && (n = "."), A(t))
      return [t];
    var r = Object.keys(t);
    ...
    var n = t.tags;
    t.machine;
    var i = $t(t, ["configuration", "transitions", "tags", "machine"]);
    return v2(v2({}, i), { tags: Array.from(n) });
    ...
    return !!(i == null ? void 0 : i.transitions.length) && i.transitions.some(function(r) {
      return r.target !== void 0 || r.actions.length;
    });
  }, e;
}();
var un = { deferEvents: false };
var re = function() {
  function e(t) {
    this.processingEvent = false, this.queue = [], this.initialized = false, this.options = v2(v2({}, un), t);
  }
...
function dn(e, t) {
  t === void 0 && (t = {});
  var n = e.initialState, i = /* @__PURE__ */ new Set(), r = [], o = false, a = function() {
    if (!o) {
      for (o = true; r.length > 0; ) {
        var h = r.shift();
        n = e.transition(n, h, c), i.forEach(function(f) {
          return f.next(n);
        });
      }
      o = false;
    }
  }, s = nn2({ id: t.id, send: function(h) {
    r.push(h), a();
  }, getSnapshot: function() {
    return n;
  }, subscribe: function(h, f, d) {
    var u = Et(h, f, d);
    return i.add(u), u.next(n), { unsubscribe: function() {
      i.delete(u);
    } };
  } }), c = { parent: t.parent, self: s, id: t.id || "anonymous", observers: i };
  return n = e.start ? e.start(c) : n, s;
}
var vn = { sync: false, autoForward: false };
var D;
(function(e) {
...
var pn = function() {
  function e(t, n) {
    ...
    var i = this;
    this.machine = t, this.delayedEventsMap = {}, this.listeners = /* @__PURE__ */ new Set(), this.contextListeners = /* @__PURE__ */ new Set(), this.stopListeners = /* @__PURE__ */ new Set(), this.doneListeners = /* @__PURE__ */ new Set(), this.eventListeners = /* @__PURE__ */ new Set(), this.sendListeners = /* @__PURE__ */ new Set(), this.initialized = false, this.status = D.NotStarted, this.children = /* @__PURE__ */ new Map(), this.forwardTo = /* @__PURE__ */ new Set(), this._outgoingQueue = [], this.init = this.start, this.send = function(f, d) {
      if (ot(f))
        return i.batch(f), i.state;
      var u = R(Lt(f, d));
      if (i.status === D.Stopped)
        return i.state;
      if (i.status !== D.Running && !i.options.deferEvents)
        throw new Error('Event "'.concat(u.name, '" was sent to uninitialized service "').concat(i.machine.id, `". Make sure .start() is called for this service, or set { deferEvents: true } in the service options.
Event: `).concat(JSON.stringify(u.data)));
      return i.scheduler.schedule(function() {
        i.forward(u);
        var l = i._nextState(u);
        i.update(l, u);
      }), i._state;
    }, this.sendTo = function(f, d, u) {
      var l = i.parent && (d === it.Parent || i.parent.id === d), y = l ? i.parent : A(d) ? d === it.Internal ? i : i.children.get(d) || st.get(d) : Be(d) ? d : void 0;
      if (!y) {
        if (!l)
      ...
      if ("machine" in y) {
        if (i.status !== D.Stopped || i.parent !== y || i.state.done) {
          var p = v2(v2({}, f), { name: f.name === Te ? "".concat(ut(i.id)) : f.name, origin: i.sessionId });
          !u && i.machine.config.predictableActionArguments ? i._outgoingQueue.push([y, p]) : y.send(p);
        }
      } else
        !u && i.machine.config.predictableActionArguments ? i._outgoingQueue.push([y, f.data]) : y.send(f.data);
    }, this._exec = function(f, d, u, l) {
      l === void 0 && (l = i.machine.options.actions);
      var y = f.exec || Jt(f.type, l), p = T(y) ? y : y ? y.exec : f.exec;
      if (p)
        try {
          return p(d, u.data, i.machine.config.predictableActionArguments ? { action: f, _event: u } : { action: f, state: i.state, _event: u });
        } catch (B) {
          throw i.parent && i.parent.send({ type: "xstate.error", data: B }), B;
        }
      switch (f.type) {
        case pt: {
          var b = f;
        ...
        case Pt:
          ...
          if (typeof g.delay == "number") {
            ...
            g.to ? i.sendTo(g._event, g.to, u === nt) : i.send(g._event);
          break;
        case oe:
          i.cancel(f.sendId);
          break;
        case Mt: {
          if (i.status !== D.Running)
            return;
          var m = f.activity;
          if (!i.machine.config.predictableActionArguments && !i.state.activities[m.id || m.type])
            break;
          if (m.type === P.Invoke) {
            var _ = pe(m.src), S = i.machine.options.services ? i.machine.options.services[_.type] : void 0, N = m.id, C = m.data, k = "autoForward" in m ? m.autoForward : !!m.forward;
            if (!S)
              return;
            var L = C ? Nt(C, d, u) : void 0;
            if (typeof S == "string")
              return;
            var w = T(S) ? S(d, u.data, { data: L, src: _, meta: m.meta }) : S;
            if (!w)
              return;
            var M = void 0;
            rt(w) && (w = L ? w.withContext(L) : w, M = { autoForward: k }), i.spawn(w, N, M);
          } else
            i.spawnActivity(m);
          break;
        }
        case Ft: {
          i.stopChild(f.activity.id);
          break;
        }
        case se:
          var x = f, j = x.label, z = x.value;
          j ? i.logger(j, z) : i.logger(z);
          break;
      }
    };
    var r = v2(v2({}, e.defaultOptions), n), o = r.clock, a = r.logger, s = r.parent, c = r.id, h = c !== void 0 ? c : t.id;
    this.id = h, this.logger = a, this.clock = o, this.parent = s, this.options = r, this.scheduler = new re({ deferEvents: this.options.deferEvents }), this.sessionId = st.bookId();
  }
  return Object.defineProperty(e.prototype, "initialState", { get: function() {
    var t = this;
    return this._initialState ? this._initialState : tt2(this, function() {
    ...
    return this._state;
  }, enumerable: false, configurable: true }), e.prototype.execute = function(t, n) {
    var i, r;
    try {
    ...
    var i, r, o, a, s, c, h, f, d = this;
    if (t._sessionid = this.sessionId, this._state = t, (!this.machine.config.predictableActionArguments || n === nt) && this.options.execute)
      this.execute(this.state);
    else
      for (var u = void 0; u = this._outgoingQueue.shift(); )
        u[0].send(u[1]);
    if (this.children.forEach(function(w) {
      d.state.children[w.id] = w;
    }), this.devTools && this.devTools.send(n.data, t), t.event)
      try {
        for (var l = E(this.eventListeners), y = l.next(); !y.done; y = l.next()) {
          var p = y.value;
          p(t.event);
        }
      } catch (w) {
    ...
    try {
      for (var b = E(this.listeners), g = b.next(); !g.done; g = b.next()) {
        var p = g.value;
        p(t, t.event);
      }
    } catch (w) {
    ...
    try {
      for (var m = E(this.contextListeners), _ = m.next(); !_.done; _ = m.next()) {
        var S = _.value;
    ...
    if (this.state.done) {
      var N = t.configuration.find(function(w) {
        return w.type === "final" && w.parent === d.machine;
    ...
    return this.status === D.Stopped ? o.complete() : (this.onDone(a), this.onStop(a)), { unsubscribe: function() {
    ...
    var n = this;
    if (this.status === D.Running)
      return this;
    this.machine._init(), st.register(this.sessionId, this), this.initialized = true, this.status = D.Running;
    var i = t === void 0 ? this.initialState : tt2(this, function() {
      return sn(t) ? n.machine.resolveState(t) : n.machine.resolveState(F2.from(t, n.machine.context));
    });
    ...
    var t, n, i, r, o, a, s, c, h, f;
    try {
      for (var d = E(this.listeners), u = d.next(); !u.done; u = d.next()) {
        var l = u.value;
    ...
    try {
      for (var b = E(this.contextListeners), g = b.next(); !g.done; g = b.next()) {
        var l = g.value;
        this.contextListeners.delete(l);
      }
    } catch (k) {
      o = { error: k };
    } finally {
    ...
    try {
      for (var m = E(this.doneListeners), _ = m.next(); !_.done; _ = m.next()) {
        var l = _.value;
    ...
    if (!this.initialized)
      return this;
    this.initialized = false, this.status = D.Stopped, this._initialState = void 0;
    try {
    ...
    if (t.length) {
      ...
      this.scheduler.schedule(function() {
        var r, o, a = n.state, s = false, c = [], h = function(l) {
          var y = R(l);
          n.forward(y), a = tt2(n, function() {
            return n.machine.transition(a, y, void 0, i || void 0);
          }), c.push.apply(c, V([], O(n.machine.config.predictableActionArguments ? a.actions : a.actions.map(function(p) {
            return cn(p, a);
          })), false)), s = s || !!a.changed;
        };
        try {
          for (var f = E(t), d = f.next(); !d.done; d = f.next()) {
            var u = d.value;
            h(u);
          }
        } catch (l) {
    ...
    if (rt(t))
      return this.spawnMachine(t, v2(v2({}, i), { id: n }));
    if (Ie(t))
    ...
    var i = this;
    n === void 0 && (n = {});
    var r = new e(t, v2(v2({}, this.options), { parent: this, id: n.id || t.id })), o = v2(v2({}, vn), n);
    o.sync && r.onTransition(function(s) {
      i.send(ce, { state: s, id: r.id });
    });
    var a = r;
    return this.children.set(r.id, a), o.autoForward && this.forwardTo.add(r.id), r.onDone(function(s) {
      i.removeChild(r.id), i.send(R(s, { origin: r.id }));
    }).start(), a;
  }, e.prototype.spawnBehavior = function(t, n) {
    var i = dn(t, { id: n, parent: this });
    return this.children.set(n, i), i;
  }, e.prototype.spawnPromise = function(t, n) {
    var i, r = this, o = false, a;
    t.then(function(c) {
      o || (a = c, r.removeChild(n), r.send(R(Ot(n, c), { origin: n })));
    }, function(c) {
      if (!o) {
        r.removeChild(n);
        var h = ut(n, c);
        try {
          ...
          r.devTools && r.devTools.send(h, r.state), r.machine.strict && r.stop();
        }
      }
    });
    var s = (i = { id: n, send: function() {
    }, subscribe: function(c, h, f) {
      var d = Et(c, h, f), u = false;
      return t.then(function(l) {
        u || (d.next(l), !u && d.complete());
      }, function(l) {
        u || d.error(l);
    ...
    var i, r = this, o = false, a = /* @__PURE__ */ new Set(), s = /* @__PURE__ */ new Set(), c, h = function(u) {
      c = u, s.forEach(function(l) {
        return l(u);
      }), !o && r.send(R(u, { origin: n }));
    }, f;
    try {
      f = t(h, function(u) {
        a.add(u);
    ...
    if (ee(f))
      return this.spawnPromise(f, n);
    var d = (i = { id: n, send: function(u) {
      return a.forEach(function(l) {
        return l(u);
      });
    }, subscribe: function(u) {
      var l = Et(u);
      return s.add(l.next), { unsubscribe: function() {
        s.delete(l.next);
      } };
    }, stop: function() {
      o = true, T(f) && f();
    ...
    var i, r = this, o, a = t.subscribe(function(c) {
      o = c, r.send(R(c, { origin: n }));
    }, function(c) {
      r.removeChild(n), r.send(R(ut(n, c), { origin: n }));
    }, function() {
      r.removeChild(n), r.send(R(Ot(n), { origin: n }));
    }), s = (i = { id: n, send: function() {
    }, subscribe: function(c, h, f) {
      return t.subscribe(c, h, f);
    }, stop: function() {
    ...
    }, stop: n || void 0, getSnapshot: function() {
    }, toJSON: function() {
      return { id: t };
    } }, i[X] = function() {
      return this;
    ...
    if (this.options.devTools && t) {
      if (t.__REDUX_DEVTOOLS_EXTENSION__) {
        ...
        this.devTools = t.__REDUX_DEVTOOLS_EXTENSION__.connect(v2(v2({ name: this.id, autoPause: true, stateSanitizer: function(i) {
          return { value: i.value, context: i.context, actions: i.actions };
        } }, n), { features: v2({ jump: false, skip: false }, n ? n.features : void 0) }), this.machine), this.devTools.init(this.state);
      }
      ln(this);
    }
  }, e.prototype.toJSON = function() {
  ...
  }, e.defaultOptions = { execute: true, deferEvents: true, clock: { setTimeout: function(t, n) {
    return setTimeout(t, n);
  }, clearTimeout: function(t) {
    return clearTimeout(t);
  } }, logger: console.log.bind(console), devTools: false }, e.interpret = Se, e;
}();
function Se(e, t) {
  var n = new pn(e, t);
  return n;
...
function xt(e) {
  return v2(v2({ type: Dt }, e), { toJSON: function() {
    e.onDone, e.onError;
    var t = $t(e, ["onDone", "onError"]);
    return v2(v2({}, t), { type: Dt, src: yn(e.src) });
  } });
}
var St = "";
var Ut = "#";
...
var mn = function() {
  function e(t, n, i, r) {
    ...
    var o = this, a;
    this.config = t, this._context = i, this.order = -1, this.__xstatenode = true, this.__cache = { events: void 0, relativeValue: /* @__PURE__ */ new Map(), initialStateValue: void 0, initialState: void 0, on: void 0, transitions: void 0, candidates: {}, delayedTransitions: void 0 }, this.idMap = {}, this.tags = [], this.options = Object.assign(gn(), n), this.parent = r == null ? void 0 : r.parent, this.key = this.config.key || (r == null ? void 0 : r.key) || this.config.id || "(machine)", this.machine = this.parent ? this.parent.machine : this, this.path = this.parent ? this.parent.path.concat(this.key) : [], this.delimiter = this.config.delimiter || (this.parent ? this.parent.delimiter : ue), this.id = this.config.id || V([this.machine.key], O(this.path), false).join(this.delimiter), this.version = this.parent ? this.parent.version : this.config.version, this.type = this.config.type || (this.config.parallel ? "parallel" : this.config.states && Object.keys(this.config.states).length ? "compound" : this.config.history ? "history" : "atomic"), this.schema = this.parent ? this.machine.schema : (a = this.config.schema) !== null && a !== void 0 ? a : {}, this.description = this.config.description, this.initial = this.config.initial, this.states = this.config.states ? ct(this.config.states, function(h, f) {
      var d, u = new e(h, {}, void 0, { parent: o, key: f });
      return Object.assign(o.idMap, v2((d = {}, d[u.id] = u, d), u.idMap)), u;
    }) : Y;
    var s = 0;
    function c(h) {
      var f, d;
      h.order = s++;
      try {
        for (var u = E(me(h)), l = u.next(); !l.done; l = u.next()) {
          var y = l.value;
          c(y);
        }
      } catch (p) {
    ...
    c(this), this.history = this.config.history === true ? "shallow" : this.config.history || false, this._transient = !!this.config.always || (this.config.on ? Array.isArray(this.config.on) ? this.config.on.some(function(h) {
      var f = h.event;
      return f === St;
    }) : St in this.config.on : false), this.strict = !!this.config.strict, this.onEntry = U(this.config.entry || this.config.onEntry).map(function(h) {
      return dt(h);
    }), this.onExit = U(this.config.exit || this.config.onExit).map(function(h) {
      return dt(h);
    }), this.meta = this.config.meta, this.doneData = this.type === "final" ? this.config.data : void 0, this.invoke = U(this.config.invoke).map(function(h, f) {
      var d, u;
      if (rt(h)) {
        var l = _t(o.id, f);
        return o.machine.options.services = v2((d = {}, d[l] = h, d), o.machine.options.services), xt({ src: l, id: l });
      } else if (A(h.src)) {
        var l = h.id || _t(o.id, f);
        return xt(v2(v2({}, h), { id: l, src: h.src }));
      } else if (rt(h.src) || T(h.src)) {
        var l = h.id || _t(o.id, f);
        return o.machine.options.services = v2((u = {}, u[l] = h.src, u), o.machine.options.services), xt(v2(v2({ id: l }, h), { src: l }));
      } else {
        var y = h.src;
        return xt(v2(v2({ id: _t(o.id, f) }, h), { src: y }));
      }
    }), this.activities = U(this.config.activities).concat(this.invoke).map(function(h) {
      return Qt(h);
  ...
  return e.prototype._init = function() {
    ...
    return new e(this.config, { actions: v2(v2({}, r), t.actions), activities: v2(v2({}, o), t.activities), guards: v2(v2({}, a), t.guards), services: v2(v2({}, s), t.services), delays: v2(v2({}, c), t.delays) }, n ?? this.context);
    ...
    return { id: this.id, key: this.key, version: this.version, context: this.context, type: this.type, initial: this.initial, history: this.history, states: ct(this.states, function(t) {
      return t.definition;
    ...
    var i = function(o, a) {
      ...
      return t.onEntry.push($e(c, { delay: o })), t.onExit.push(Qe(c)), c;
    }, r = ot(n) ? n.map(function(o, a) {
      var s = i(o.delay, a);
      return v2(v2({}, o), { event: s });
    }) : I(Object.keys(n).map(function(o, a) {
      var s = n[o], c = A(s) ? { target: s } : s, h = isNaN(+o) ? o : +o, f = i(h, a);
      return U(c).map(function(d) {
        return v2(v2({}, d), { event: f, delay: h });
      });
    }));
    return r.map(function(o) {
      var a = o.delay;
      return v2(v2({}, t.formatTransition(o)), { delay: a });
    });
  }, e.prototype.getStateNodes = function(t) {
    var n, i = this;
    if (!t)
      return [];
    var r = t instanceof F2 ? t.value : lt(t, this.delimiter);
    if (A(r)) {
      var o = this.getStateNode(r).initial;
      return o !== void 0 ? this.getStateNodes((n = {}, n[r] = o, n)) : [this, this.states[r]];
    }
    var a = Object.keys(r), s = [this];
    ...
    var n = t instanceof F2 ? t : F2.create(t), i = Array.from(ht([], this.getStateNodes(n.value)));
    return new F2(v2(v2({}, n), { value: this.resolve(n.value), configuration: i, done: kt(i, this), tags: ie(i), machine: this.machine }));
    ...
    try {
      for (var s = E(Object.keys(t)), c = s.next(); !c.done; c = s.next()) {
        var h = c.value, f = t[h];
        if (f) {
          var d = this.getStateNode(h), u = d._transition(f, n, i);
          u && (a[h] = u);
        }
      }
    } catch (g) {
    ...
    var l = Object.keys(a).map(function(g) {
      return a[g];
    }), y = I(l.map(function(g) {
      return g.transitions;
    })), p = l.some(function(g) {
      return g.transitions.length > 0;
    });
    if (!p)
      return this.next(n, i);
    var b = I(Object.keys(a).map(function(g) {
      return a[g].configuration;
    }));
    return { transitions: y, exitSet: I(l.map(function(g) {
      return g.exitSet;
    })), configuration: b, source: n, actions: I(Object.keys(a).map(function(g) {
      return a[g].actions;
    })) };
    ...
    var i, r, o = this, a = n.name, s = [], c = [], h;
    try {
      for (var f = E(this.getCandidates(a)), d = f.next(); !d.done; d = f.next()) {
        var u = d.value, l = u.cond, y = u.in, p = t.context, b = y ? A(y) && G(y) ? t.matches(lt(this.getStateNodeById(y).path, this.delimiter)) : Xt(lt(y, this.delimiter), Le(this.path.slice(0, -2))(t.value)) : true, g = false;
        try {
          g = !l || ve(this.machine, l, p, n, t);
        } catch (S) {
          throw new Error("Unable to evaluate guard '".concat(l.name || l.type, "' in transition for event '").concat(a, "' in state node '").concat(this.id, `':
`).concat(S.message));
        }
        if (g && b) {
          u.target !== void 0 && (c = u.target), s.push.apply(s, V([], O(u.actions), false)), h = u;
          break;
        }
      }
    } catch (S) {
    ...
    if (h) {
      if (!c.length)
        return { transitions: [h], exitSet: [], configuration: t.value ? [this] : [], source: t, actions: s };
      var m = I(c.map(function(S) {
        return o.getRelativeStateNodes(S, t.historyValue);
      })), _ = !!h.internal;
      return { transitions: [h], exitSet: _ ? [] : I(c.map(function(S) {
        return o.getPotentiallyReenteringNodes(S);
      })), configuration: m, source: t, actions: s };
    }
  }, e.prototype.getPotentiallyReenteringNodes = function(t) {
    if (this.order < t.order)
      return [this];
    for (var n = [], i = this, r = t; i && i !== r; )
      n.push(i), i = i.parent;
    return i !== r ? [] : (n.push(r), n);
  }, e.prototype.getActions = function(t, n, i, r, o, a, s) {
    var c, h, f, d, u = this, l = a ? ht([], this.getStateNodes(a.value)) : [], y = /* @__PURE__ */ new Set();
    try {
      for (var p = E(Array.from(t).sort(function(x, j) {
        return x.order - j.order;
      })), b = p.next(); !b.done; b = p.next()) {
        var g = b.value;
        (!ft(l, g) || ft(i.exitSet, g) || g.parent && y.has(g.parent)) && y.add(g);
      }
    } catch (x) {
      c = { error: x };
    } finally {
    ...
    try {
      for (var m = E(l), _ = m.next(); !_.done; _ = m.next()) {
        var g = _.value;
    ...
    var S = Array.from(y).sort(function(x, j) {
      ...
      return { type: "entry", actions: Q(s ? V(V([], O(j), false), O(z), false) : V(V([], O(z), false), O(j), false), u.machine.options.actions) };
    }).concat({ type: "state_done", actions: C.map(function(x) {
      return qe(x);
    }) }), L = Array.from(N).map(function(x) {
      return { type: "exit", actions: Q(V(V([], O(x.onExit), false), O(x.activities.map(function(j) {
        return We(j);
      })), false), u.machine.options.actions) };
    }), w = L.concat({ type: "transition", actions: Q(i.actions, this.machine.options.actions) }).concat(k);
    if (n) {
      var M = Q(I(V([], O(t), false).sort(function(x, j) {
        return j.order - x.order;
      }).map(function(x) {
        return x.onExit;
      ...
      return w.concat({ type: "stop", actions: M });
    }
    return w;
    ...
    var o = R(n), a;
    if (t instanceof F2)
      a = i === void 0 ? t : this.resolveState(F2.from(t, i));
    else {
      var s = A(t) ? this.resolve(Tt(this.getResolvedPath(t))) : this.resolve(t), c = i ?? this.machine.context;
      a = this.resolveState(F2.from(s, c));
    }
    if (this.strict && !this.events.includes(o.name) && !Ve(o.name))
      throw new Error("Machine '".concat(this.id, "' does not accept event '").concat(o.name, "'"));
    var h = this._transition(a.value, a, o) || { transitions: [], configuration: [], exitSet: [], source: a, actions: [] }, f = ht([], this.getStateNodes(a.value)), d = h.configuration.length ? ht(f, h.configuration) : f;
    return h.configuration = V([], O(d), false), this.resolveTransition(h, a, a.context, r, o);
  }, e.prototype.resolveRaisedTransition = function(t, n, i, r) {
    var o, a = t.actions;
    return t = this.transition(t, n, void 0, r), t._event = i, t.event = i.data, (o = t.actions).unshift.apply(o, V([], O(a), false)), t;
  }, e.prototype.resolveTransition = function(t, n, i, r, o) {
    var a, s, c, h, f = this;
    o === void 0 && (o = nt);
    var d = t.configuration, u = !n || t.transitions.length > 0, l = u ? t.configuration : n ? n.configuration : [], y = kt(l, this), p = u ? rn(this.machine, d) : void 0, b = n ? n.historyValue ? n.historyValue : t.source ? this.machine.historyValue(n.value) : void 0 : void 0, g = this.getActions(new Set(l), y, t, i, o, n, r), m = n ? v2({}, n.activities) : {};
    try {
      for (var _ = E(g), S = _.next(); !S.done; S = _.next()) {
        var N = S.value;
        try {
          for (var C = (c = void 0, E(N.actions)), k = C.next(); !k.done; k = C.next()) {
            var L = k.value;
            L.type === Mt ? m[L.activity.id || L.activity.type] = L : L.type === Ft && (m[L.activity.id || L.activity.type] = false);
          }
        } catch (q) {
          c = { error: q };
        } finally {
    ...
    var w = O(jt(this, n, i, o, g, r, this.machine.config.predictableActionArguments || this.machine.config.preserveActionOrder), 2), M = w[0], x = w[1], j = O(Me(M, Bt), 2), z = j[0], B = j[1], at = M.filter(function(q) {
      ...
      return q[K.activity.id] = Ge(K.activity, f.machine, x, o), q;
    }, n ? v2({}, n.children) : {}), $ = new F2({ value: p || n.value, context: x, _event: o, _sessionid: n ? n._sessionid : null, historyValue: p ? b ? De(b, p) : void 0 : n ? n.historyValue : void 0, history: !p || t.source ? n : void 0, actions: p ? B : [], activities: p ? m : n ? n.activities : {}, events: [], configuration: l, transitions: t.transitions, children: yt, done: y, tags: ie(l), machine: this }), H = i !== x;
    $.changed = o.name === ce || H;
    var W = $.history;
    W && delete W.history;
    var Wt = !y && (this._transient || d.some(function(q) {
      return q._transient;
    }));
    if (!u && (!Wt || o.name === St))
      return $;
    var J = $;
    if (!y)
      for (Wt && (J = this.resolveRaisedTransition(J, { type: Oe }, o, r)); z.length; ) {
        var we = z.shift();
    ...
    var n, i = this;
    if (!t)
      return this.initialStateValue || Y;
    switch (this.type) {
      case "parallel":
  ...
  }, enumerable: false, configurable: true }), e.prototype.getInitialState = function(t, n) {
    this._init();
    var i = this.getStateNodes(t);
    return this.resolveTransition({ configuration: i, exitSet: [], transitions: [], source: void 0, actions: [] }, void 0, n ?? this.machine.context, void 0);
    ...
    return t;
  }, enumerable: false, configurable: true }), e.prototype.getRelativeStateNodes = function(t, n, i) {
    return i === void 0 && (i = true), i ? t.type === "history" ? t.resolveHistory(n) : t.initialStateNodes : [t];
    ...
    if (Object.keys(this.states).length)
      return { current: t || this.initialStateValue, states: te(this.states, function(n, i) {
        if (!t)
    ...
    return A(o) ? [i.getStateNode(o)] : I(wt(o).map(function(a) {
    ...
    if (o)
      try {
        for (var s = E(Object.keys(o)), c = s.next(); !c.done; c = s.next()) {
          ...
          if (f.states)
            try {
              for (var d = (i = void 0, E(f.events)), u = d.next(); !u.done; u = d.next()) {
                var l = u.value;
                a.add("".concat(l));
              }
            } catch (y) {
    ...
    if (t !== void 0)
      return t.map(function(i) {
        ...
        if (r && !n.parent)
          return n.getStateNodeByPath(i.slice(1));
        var o = r ? n.key + i : i;
        if (n.parent)
          try {
...
`).concat(s.message));
    ...
    }) : true, o = this.machine.options.guards, a = this.resolveTarget(i), s = v2(v2({}, t), { actions: Q(U(t.actions)), cond: de(t.cond, o), target: a, source: this, internal: r, eventType: t.event, toJSON: function() {
      return v2(v2({}, s), { target: s.target ? s.target.map(function(c) {
        return "#".concat(c.id);
      }) : void 0, source: "#".concat(n.id) });
    } });
    return s;
    ...
    if (!this.config.on)
      ...
      var o = this.config.on, a = It, s = o[a], c = s === void 0 ? [] : s, h = $t(o, [typeof a == "symbol" ? a : a + ""]);
      r = I(Object.keys(h).map(function(m) {
        var _ = Z(m, h[m]);
        return _;
      }).concat(Z(It, c)));
    }
    var f = this.config.always ? Z("", this.config.always) : [], d = this.config.onDone ? Z(String(bt(this.id)), this.config.onDone) : [], u = I(this.invoke.map(function(m) {
      var _ = [];
      return m.onDone && _.push.apply(_, V([], O(Z(String(Ot(m.id)), m.onDone)), false)), m.onError && _.push.apply(_, V([], O(Z(String(ut(m.id)), m.onError)), false)), _;
    })), l = this.after, y = I(V(V(V(V([], O(d), false), O(u), false), O(r), false), O(f), false).map(function(m) {
      return U(m).map(function(_) {
        return i.formatTransition(_);
      });
    }));
    try {
      for (var p = E(l), b = p.next(); !b.done; b = p.next()) {
        var g = b.value;
        y.push(g);
      }
    } catch (m) {
...
var et = { click: "onClick", mouseenter: "onMouseEnter", mouseleave: "onMouseLeave", complete: "onComplete", after: "onAfter", enter: "onEnter", show: "onShow" };
Object.values(et);
...
var Nn = class {
  ...
  start(e) {
    ...
    if (typeof t > "u")
      throw v(`invalid state machine id ${e}`);
    this._service = Se(_n(t)), this._addEventListeners(), this._service.start();
  }
  stop() {
    var _a;
    this._removeEventListeners(), (_a = this._service) == null ? void 0 : _a.stop(), this._player.stop();
  }
  _removeEventListeners() {
    var _a;
    this._requiresDomElement();
    for (let [e, t] of this._domListeners)
      e === "visibilityChange" && this._player.stopPlayOnShow(), (_a = this._domElement) == null ? void 0 : _a.removeEventListener(e, t), this._domListeners.delete(e);
    for (let [e, t] of this._playerListeners)
      this._player.removeEventListener(e, t), this._playerListeners.delete(e);
  }
  _addEventListeners() {
    this._requiresDomElement();
    let e = (n) => {
    ...
    this._service.subscribe((n) => {
      ...
      if (typeof n.changed > "u" || n.changed) {
        ...
        for (let i of n.nextEvents)
          if (bn.filter((r) => r !== "complete" && r !== "show").includes(i)) {
            let r = t(i);
            this._domListeners.set(i, r), (_a = this._domElement) == null ? void 0 : _a.addEventListener(i, r, { once: true });
          } else if (i === "complete") {
            let r = t(i);
            this._player.addEventListener(i, r), this._playerListeners.set(i, r);
          } else if (i === "show") {
            let r = t(i);
            this._player.addIntersectionObserver({ callbackOnIntersect: (o) => {
              o > 0 && (o !== 100 && this._onShowPrevValue !== o && r(), this._onShowPrevValue = o);
            }, threshold: [] }), this._domListeners.set("visibilityChange", r);
          }
      }
    });
  }
  ...
  _transformToXStateSchema(e) {
    ...
    for (let n of e) {
      let i = {}, r = {};
      if (r.id = n.descriptor.id, typeof n.descriptor.initial < "u" && (r.initial = n.descriptor.initial), typeof n < "u") {
        let o = n.states;
        for (let a in o)
          if (typeof o[a] < "u" && o[a]) {
            let s = o[a], c = s.playbackSettings, h$1 = Object.keys(s).filter((u) => u.startsWith("on")), f = {}, d$1 = {};
            for (let u of h$1)
              if (typeof s[u] < "u") {
                let l = s[u];
                if (u === et.after) {
                  let y = l;
                  d$1[y.ms] = { target: (l == null ? void 0 : l.state) ?? "" };
                } else
                  u === et.enter ? f[nn(et, u)] = { target: (l == null ? void 0 : l.state) ?? "" } : f[nn(et, u)] = { target: (l == null ? void 0 : l.state) ?? "" };
              }
            i[a] = { entry: () => {
              !this._player.getAnimationInstance() || s.animationId && s.animationId !== this._player.currentAnimationId ? this._player.play(s.animationId, () => ({ ...F, ...c })).then(() => {
                this._updatePlaybackSettings(c);
              }).catch((u) => {
                tt(`State machine error: ${u.message}`);
              }) : this._updatePlaybackSettings(c);
            }, exit: () => {
              typeof c.segments < "u" && this._player.resetSegments(false), typeof c.playOnScroll < "u" && this._player.stopPlayOnScroll();
            }, on: f, after: d$1, meta: c };
          }
      }
      r.states = i, t.set(r.id, r);
    }
    return t;
  }
  _handlePlaySegments(e) {
    if (typeof e.segments == "string")
      this._player.goToAndPlay(e.segments, true);
    else {
      let [t, n] = e.segments, i = t;
      t !== 0 && t === n && (i = t - 1), t === 0 && t === n ? this._player.goToAndPlay(t, true) : this._player.playSegments([i, n], true);
    }
  }
  _handlePlayOnScroll(e) {
    ...
    if (e.segments && typeof e.segments != "string") {
      let n = e.segments;
      this._player.playOnScroll({ threshold: t, segments: n });
    } else
      this._player.playOnScroll({ threshold: t });
  }
  ...
  _requiresDomElement() {
    if (!this._domElement)
      throw v("Requires a DOM element to attach events.");
  }
};
export {
  Nn as DotLottieStateMachineManager
};
/*! Bundled license information:

@dotlottie/player-component/dist/dotlottie-state-machine-manager-EQLJDSHN-GQNUJPNH.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=dotlottie-state-machine-manager-EQLJDSHN-GQNUJPNH-ZWBLYZ4U.js.map
