...
// node_modules/@dotlottie/player-component/dist/dist-4JHQ5UB4-ADENUQD3.mjs
var it = u((m, d) => {
  var o = String, h = function() {
    return { isColorSupported: false, reset: o, bold: o, dim: o, italic: o, underline: o, inverse: o, hidden: o, strikethrough: o, black: o, red: o, green: o, yellow: o, blue: o, magenta: o, cyan: o, white: o, gray: o, bgBlack: o, bgRed: o, bgGreen: o, bgYellow: o, bgBlue: o, bgMagenta: o, bgCyan: o, bgWhite: o };
  };
...
var ze = u((m, d) => {
  var o = it(), h = st(), c = class extends Error {
    ...
    showSourceCode(r) {
      ...
      if (r) {
        let { bold: s, red: e, gray: u2 } = o.createColors(true);
        t = (a) => s(e(a)), p = (a) => u2(a);
      } else
        t = p = (s) => s;
      return n.slice(g, l).map((s, e) => {
        let u2 = g + 1 + e, a = " " + (" " + u2).slice(-f) + " | ";
        if (u2 === this.line) {
...
`, emptyBody: "", commentLeft: " ", commentRight: " ", semicolon: false };
  ...
  var c = class {
    ...
    stringify(r, i) {
      if (!this[r.type])
        throw new Error("Unknown AST node type " + r.type + ". Maybe you need to change PostCSS stringifier.");
      this[r.type](r, i);
    }
    document(r) {
      this.body(r);
    ...
    atrule(r, i) {
      ...
      if (typeof r.raws.afterName < "u" ? n += r.raws.afterName : g && (n += " "), r.nodes)
        this.block(r, n + g);
      else {
    ...
    body(r) {
      ...
      for (; i > 0 && r.nodes[i].type === "comment"; )
        i -= 1;
    ...
    raw(r, i, n) {
      let g;
      if (n || (n = i), i && (g = r.raws[i], typeof g < "u"))
        return g;
      let l = r.parent;
      if (n === "before" && (!l || l.type === "root" && l.first === r || l && l.type === "document"))
        return "";
      if (!l)
        return o[n];
      let f = r.root();
      if (f.rawCache || (f.rawCache = {}), typeof f.rawCache[n] < "u")
        return f.rawCache[n];
      if (n === "before" || n === "after")
        return this.beforeAfter(r, n);
      {
        let t = "raw" + h(n);
        this[t] ? g = this[t](f, r) : f.walk((p) => {
          if (g = p.raws[i], typeof g < "u")
            return false;
        });
      }
    ...
    rawSemicolon(r) {
      let i;
      return r.walk((n) => {
        if (n.nodes && n.nodes.length && n.last.type === "decl" && (i = n.raws.semicolon, typeof i < "u"))
          return false;
      }), i;
    }
    rawEmptyBody(r) {
      let i;
      return r.walk((n) => {
        if (n.nodes && n.nodes.length === 0 && (i = n.raws.after, typeof i < "u"))
          return false;
      }), i;
    }
    rawIndent(r) {
      if (r.raws.indent)
        return r.raws.indent;
      let i;
      return r.walk((n) => {
        let g = n.parent;
...
`);
          return i = l[l.length - 1], i = i.replace(/\S/g, ""), false;
        }
      }), i;
    }
    rawBeforeComment(r, i) {
      ...
      return r.walkComments((g) => {
        if (typeof g.raws.before < "u")
          return n = g.raws.before, n.includes(`
`) && (n = n.replace(/[^\n]+$/, "")), false;
...
`) && (n = n.replace(/[^\n]+$/, "")), false;
    ...
    rawBeforeRule(r) {
      let i;
      return r.walk((n) => {
        if (n.nodes && (n.parent !== r || r.first !== n) && typeof n.raws.before < "u")
    ...
    rawBeforeClose(r) {
      ...
      return r.walk((n) => {
        if (n.nodes && n.nodes.length > 0 && typeof n.raws.after < "u")
          return i = n.raws.after, i.includes(`
`) && (i = i.replace(/[^\n]+$/, "")), false;
      }), i && (i = i.replace(/\S/g, "")), i;
    }
    rawBeforeOpen(r) {
      let i;
      return r.walk((n) => {
        if (n.type !== "decl" && (i = n.raws.between, typeof i < "u"))
          return false;
      }), i;
    }
    rawColon(r) {
      ...
      return r.walkDecls((n) => {
        if (typeof n.raws.between < "u")
          return i = n.raws.between.replace(/[^\s:]/g, ""), false;
      }), i;
    }
    beforeAfter(r, i) {
      let n;
...
var we = u((m, d) => {
  ...
  function n(l, f) {
    ...
    for (let p in l) {
      if (!Object.prototype.hasOwnProperty.call(l, p) || p === "proxyCache")
        continue;
      let s = l[p], e = typeof s;
      p === "parent" && e === "object" ? f && (t[p] = f) : p === "source" ? t[p] = s : Array.isArray(s) ? t[p] = s.map((u2) => n(u2, t)) : (e === "object" && s !== null && (s = n(s)), t[p] = s);
    }
    return t;
  }
  var g = class {
    constructor(l = {}) {
      this.raws = {}, this[o] = false, this[h] = true;
      for (let f in l)
        if (f === "nodes") {
          this.nodes = [];
          for (let t of l[f])
    ...
    error(l, f = {}) {
      if (this.source) {
        ...
        return this.source.input.error(l, { line: t.line, column: t.column }, { line: p.line, column: p.column }, f);
      }
      return new c(l);
    }
    warn(l, f, t) {
    ...
    replaceWith(...l) {
      if (this.parent) {
        let f = this, t = false;
        for (let p of l)
          p === this ? t = true : t ? (this.parent.insertAfter(f, p), f = p) : this.parent.insertBefore(f, p);
        t || this.remove();
      }
      return this;
    }
    ...
    toJSON(l, f) {
      ...
      let s = 0;
      for (let e in this) {
        if (!Object.prototype.hasOwnProperty.call(this, e) || e === "parent" || e === "proxyCache")
          continue;
        let u2 = this[e];
        if (Array.isArray(u2))
          t[e] = u2.map((a) => typeof a == "object" && a.toJSON ? a.toJSON(null, f) : a);
        else if (typeof u2 == "object" && u2.toJSON)
          t[e] = u2.toJSON(null, f);
        else if (e === "source") {
          let a = f.get(u2.input);
          a == null && (a = s, f.set(u2.input, s), s++), t[e] = { inputId: a, start: u2.start, end: u2.end };
        } else
          t[e] = u2;
      }
      return p && (t.inputs = [...f.keys()].map((e) => e.toJSON())), t;
    }
    positionInside(l) {
      ...
      for (let s = 0; s < l; s++)
        f[s] === `
` ? (t = 1, p += 1) : t += 1;
      return { line: p, column: t };
    }
    positionBy(l) {
      let f = this.source.start;
      if (l.index)
        f = this.positionInside(l.index);
      else if (l.word) {
    ...
    rangeBy(l) {
      let f = { line: this.source.start.line, column: this.source.start.column }, t = this.source.end ? { line: this.source.end.line, column: this.source.end.column + 1 } : { line: f.line, column: f.column + 1 };
      if (l.word) {
        let p = this.toString().indexOf(l.word);
        p !== -1 && (f = this.positionInside(p), t = this.positionInside(p + l.word.length));
      } else
        l.start ? f = { line: l.start.line, column: l.start.column } : l.index && (f = this.positionInside(l.index)), l.end ? t = { line: l.end.line, column: l.end.column } : l.endIndex ? t = this.positionInside(l.endIndex) : l.index && (t = this.positionInside(l.index + 1));
      return (t.line < f.line || t.line === f.line && t.column <= f.column) && (t = { line: f.line, column: f.column + 1 }), { start: f, end: t };
    }
    getProxyProcessor() {
      return { set(l, f, t) {
        return l[f] === t || (l[f] = t, (f === "prop" || f === "value" || f === "name" || f === "params" || f === "important" || f === "text") && l.markDirty()), true;
      }, get(l, f) {
...
var ot = u((m, d) => {
  var o = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", h = (r, i = 21) => (n = i) => {
    let g = "", l = n;
    for (; l--; )
      g += r[Math.random() * r.length | 0];
    return g;
  }, c = (r = 21) => {
    let i = "", n = r;
    for (; n--; )
      i += o[Math.random() * 64 | 0];
    return i;
  };
  d.exports = { nanoid: c, customAlphabet: h };
});
var at = u(() => {
});
var lt = u((m, d) => {
  ...
  var l = class {
    ...
    startWith(f, t) {
      return f ? f.substr(0, t.length) === t : false;
    }
    getAnnotationURL(f) {
    ...
    decodeInline(f) {
      ...
      if (s.test(f) || e.test(f))
        return decodeURIComponent(f.substr(RegExp.lastMatch.length));
      if (t.test(f) || p.test(f))
        return g(f.substr(RegExp.lastMatch.length));
      let u2 = f.match(/data:application\/json;([^,]+),/)[1];
      throw new Error("Unsupported source map encoding " + u2);
    }
    loadFile(f) {
      if (this.root = i(f), c(f))
        return this.mapFile = f, r(f, "utf-8").toString().trim();
    }
    loadMap(f, t) {
      if (t === false)
        return false;
      if (t) {
        ...
        if (typeof t == "function") {
          ...
          if (p) {
            ...
            if (!s)
              throw new Error("Unable to load previous source map: " + p.toString());
            return s;
          }
        } else {
          if (t instanceof o)
            return h.fromSourceMap(t).toString();
          if (t instanceof h)
            return t.toString();
          if (this.isMap(t))
...
var ve = u((m, d) => {
  var { SourceMapConsumer: o, SourceMapGenerator: h } = oe(), { fileURLToPath: c, pathToFileURL: r } = Ue(), { resolve: i, isAbsolute: n } = ae(), { nanoid: g } = ot(), l = st(), f = ze(), t = lt(), p = Symbol("fromOffsetCache"), s = !!(o && h), e = !!(i && n), u2 = class {
    constructor(a, y = {}) {
      if (a === null || typeof a > "u" || typeof a == "object" && !a.toString)
        throw new Error(`PostCSS received ${a} instead of CSS string`);
      if (this.css = a.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = true, this.css = this.css.slice(1)) : this.hasBOM = false, y.from && (!e || /^\w+:\/\//.test(y.from) || n(y.from) ? this.file = y.from : this.file = i(y.from)), e && s) {
...
`);
        ...
        let b = 0;
        for (let v2 = 0, C = k.length; v2 < C; v2++)
          w[v2] = b, b += k[v2].length + 1;
        this[p] = w;
      }
      y = w[w.length - 1];
      let x = 0;
    ...
    error(a, y, w, x = {}) {
      ...
      if (y && typeof y == "object") {
        ...
        if (typeof F.offset == "number") {
          ...
          b = F.line, v2 = F.column;
      } else if (!w) {
        let A = this.fromOffset(y);
        y = A.line, w = A.col;
      }
      let C = this.origin(y, w, b, v2);
      return C ? k = new f(a, C.endLine === void 0 ? C.line : { line: C.line, column: C.column }, C.endLine === void 0 ? C.column : { line: C.endLine, column: C.endColumn }, C.source, C.file, x.plugin) : k = new f(a, b === void 0 ? y : { line: y, column: w }, b === void 0 ? w : { line: b, column: v2 }, this.css, this.file, x.plugin), k.input = { line: y, column: w, endLine: b, endColumn: v2, source: this.css }, this.file && (r && (k.input.url = r(this.file).toString()), k.input.file = this.file), k;
    }
    origin(a, y, w, x) {
      if (!this.map)
        return false;
      let k = this.map.consumer(), b = k.originalPositionFor({ line: a, column: y });
      if (!b.source)
        return false;
      let v2;
      typeof w == "number" && (v2 = k.originalPositionFor({ line: w, column: x }));
      let C;
      n(b.source) ? C = r(b.source) : C = new URL(b.source, this.map.consumer().sourceRoot || r(this.map.mapFile));
      let A = { url: C.toString(), line: b.line, column: b.column, endLine: v2 && v2.line, endColumn: v2 && v2.column };
      if (C.protocol === "file:")
        if (c)
          A.file = c(C);
        else
    ...
    toJSON() {
      ...
      return this.map && (a.map = { ...this.map }, a.map.consumerCache && (a.map.consumerCache = void 0)), a;
    }
  };
  d.exports = u2, u2.default = u2, l && l.registerInput && l.registerInput(u2);
});
var ut = u((m, d) => {
  var { SourceMapConsumer: o, SourceMapGenerator: h } = oe(), { dirname: c, resolve: r, relative: i, sep: n } = ae(), { pathToFileURL: g } = Ue(), l = ve(), f = !!(o && h), t = !!(c && r && i && n), p = class {
    constructor(s, e, u2, a) {
      this.stringify = s, this.mapOpts = u2.map || {}, this.root = e, this.opts = u2, this.css = a, this.usesFileUrls = !this.mapOpts.from && this.mapOpts.absolute;
    }
    isMap() {
    ...
    isInline() {
      ...
      return typeof s < "u" && s !== true ? false : this.previous().length ? this.previous().some((e) => e.inline) : true;
    }
    isSourcesContent() {
      ...
      if (this.mapOpts.annotation !== false)
        if (this.root) {
          ...
          for (let e = this.root.nodes.length - 1; e >= 0; e--)
            s = this.root.nodes[e], s.type === "comment" && s.text.indexOf("# sourceMappingURL=") === 0 && this.root.removeChild(e);
        } else
    ...
    setSourcesContent() {
      ...
      if (this.root)
        this.root.walk((e) => {
          if (e.source) {
            let u2 = e.source.input.from;
            if (u2 && !s[u2]) {
              s[u2] = true;
              let a = this.usesFileUrls ? this.toFileUrl(u2) : this.toUrl(this.path(u2));
    ...
    applyPrevMaps() {
      for (let s of this.previous()) {
        let e = this.toUrl(this.path(s.file)), u2 = s.root || c(s.file), a;
        this.mapOpts.sourcesContent === false ? (a = new o(s.text), a.sourcesContent && (a.sourcesContent = a.sourcesContent.map(() => null))) : a = s.consumer(), this.map.applySourceMap(a, e, this.toUrl(this.path(u2)));
      }
    }
    isAnnotation() {
...
`), this.css += e + "/*# sourceMappingURL=" + s + " */";
    ...
    generateMap() {
      if (this.root)
        ...
        this.map = new h({ file: this.outputFile() }), this.map.addMapping({ source: this.opts.from ? this.toUrl(this.path(this.opts.from)) : "<no source>", generated: { line: 1, column: 0 }, original: { line: 1, column: 0 } });
      return this.isSourcesContent() && this.setSourcesContent(), this.root && this.previous().length > 0 && this.applyPrevMaps(), this.isAnnotation() && this.addAnnotation(), this.isInline() ? [this.css] : [this.css, this.map];
    }
    path(s) {
      if (s.indexOf("<") === 0 || /^\w+:\/\//.test(s) || this.mapOpts.absolute)
        return s;
    ...
    generateString() {
      this.css = "", this.map = new h({ file: this.outputFile() });
      let s = 1, e = 1, u2 = "<no source>", a = { source: "", generated: { line: 0, column: 0 }, original: { line: 0, column: 0 } }, y, w;
      this.stringify(this.root, (x, k, b) => {
        if (this.css += x, k && b !== "end" && (a.generated.line = s, a.generated.column = e - 1, k.source && k.source.start ? (a.source = this.sourcePath(k), a.original.line = k.source.start.line, a.original.column = k.source.start.column - 1, this.map.addMapping(a)) : (a.source = u2, a.original.line = 1, a.original.column = 0, this.map.addMapping(a))), y = x.match(/\n/g), y ? (s += y.length, w = x.lastIndexOf(`
`), e = x.length - w) : e += x.length, k && b !== "start") {
          let v2 = k.parent || { raws: {} };
          (!(k.type === "decl" || k.type === "atrule" && !k.nodes) || k !== v2.last || v2.raws.semicolon) && (k.source && k.source.end ? (a.source = this.sourcePath(k), a.original.line = k.source.end.line, a.original.column = k.source.end.column - 1, a.generated.line = s, a.generated.column = e - 2, this.map.addMapping(a)) : (a.source = u2, a.original.line = 1, a.original.column = 0, a.generated.line = s, a.generated.column = e - 1, this.map.addMapping(a)));
        }
      });
    }
    generate() {
      if (this.clearAnnotation(), t && f && this.isMap())
...
var ee = u((m, d) => {
  ...
  function t(e) {
    return e.map((u2) => (u2.nodes && (u2.nodes = t(u2.nodes)), delete u2.source, u2));
  }
  function p(e) {
    if (e[o] = false, e.proxyOf.nodes)
      for (let u2 of e.proxyOf.nodes)
        p(u2);
  }
  var s = class extends i {
    ...
    each(e) {
      if (!this.proxyOf.nodes)
        return;
      let u2 = this.getIterator(), a, y;
      for (; this.indexes[u2] < this.proxyOf.nodes.length && (a = this.indexes[u2], y = e(this.proxyOf.nodes[a], a), y !== false); )
        this.indexes[u2] += 1;
      return delete this.indexes[u2], y;
    }
    walk(e) {
      return this.each((u2, a) => {
        let y;
        try {
          y = e(u2, a);
        } catch (w) {
          throw u2.addToError(w);
        }
        return y !== false && u2.walk && (y = u2.walk(e)), y;
      });
    }
    walkDecls(e, u2) {
      return u2 ? e instanceof RegExp ? this.walk((a, y) => {
    ...
    append(...e) {
      for (let u2 of e) {
        let a = this.normalize(u2, this.last);
        for (let y of a)
          this.proxyOf.nodes.push(y);
      }
    ...
    prepend(...e) {
      e = e.reverse();
      for (let u2 of e) {
        let a = this.normalize(u2, this.first, "prepend").reverse();
        for (let y of a)
          this.proxyOf.nodes.unshift(y);
        for (let y in this.indexes)
          this.indexes[y] = this.indexes[y] + a.length;
      }
      return this.markDirty(), this;
    }
    cleanRaws(e) {
      if (super.cleanRaws(e), this.nodes)
        for (let u2 of this.nodes)
          u2.cleanRaws(e);
    }
    insertBefore(e, u2) {
      let a = this.index(e), y = a === 0 ? "prepend" : false, w = this.normalize(u2, this.proxyOf.nodes[a], y).reverse();
      a = this.index(e);
      for (let k of w)
        this.proxyOf.nodes.splice(a, 0, k);
      let x;
      for (let k in this.indexes)
        x = this.indexes[k], a <= x && (this.indexes[k] = x + w.length);
      return this.markDirty(), this;
    }
    insertAfter(e, u2) {
      let a = this.index(e), y = this.normalize(u2, this.proxyOf.nodes[a]).reverse();
      a = this.index(e);
      for (let x of y)
        this.proxyOf.nodes.splice(a + 1, 0, x);
      let w;
      for (let x in this.indexes)
        w = this.indexes[x], a < w && (this.indexes[x] = w + y.length);
      return this.markDirty(), this;
    }
    removeChild(e) {
      ...
      for (let a in this.indexes)
        u2 = this.indexes[a], u2 >= e && (this.indexes[a] = u2 - 1);
      return this.markDirty(), this;
    }
    removeAll() {
    ...
    replaceValues(e, u2, a) {
      return a || (a = u2, u2 = {}), this.walkDecls((y) => {
        u2.props && !u2.props.includes(y.prop) || u2.fast && !y.value.includes(u2.fast) || (y.value = y.value.replace(e, a));
      }), this.markDirty(), this;
    }
    every(e) {
    ...
    normalize(e, u2) {
      if (typeof e == "string")
        ...
        typeof e.value != "string" && (e.value = String(e.value)), e = [new c(e)];
      } else if (e.selector)
        e = [new g(e)];
      else if (e.name)
        e = [new l(e)];
      ...
      return e.map((a) => (a[h] || s.rebuild(a), a = a.proxyOf, a.parent && a.parent.removeChild(a), a[o] && p(a), typeof a.raws.before > "u" && u2 && typeof u2.raws.before < "u" && (a.raws.before = u2.raws.before.replace(/\S/g, "")), a.parent = this.proxyOf, a));
    }
    getProxyProcessor() {
      return { set(e, u2, a) {
        return e[u2] === a || (e[u2] = a, (u2 === "name" || u2 === "params" || u2 === "selector") && e.markDirty()), true;
      }, get(e, u2) {
        return u2 === "proxyOf" ? e : e[u2] ? u2 === "each" || typeof u2 == "string" && u2.startsWith("walk") ? (...a) => e[u2](...a.map((y) => typeof y == "function" ? (w, x) => y(w.toProxy(), x) : y)) : u2 === "every" || u2 === "some" ? (a) => e[u2]((y, ...w) => a(y.toProxy(), ...w)) : u2 === "root" ? () => e.root().toProxy() : u2 === "nodes" ? e.nodes.map((a) => a.toProxy()) : u2 === "first" || u2 === "last" ? e[u2].toProxy() : e[u2] : e[u2];
      } };
    }
    getIterator() {
  ...
  s.registerParse = (e) => {
    ...
    e.type === "atrule" ? Object.setPrototypeOf(e, l.prototype) : e.type === "rule" ? Object.setPrototypeOf(e, g.prototype) : e.type === "decl" ? Object.setPrototypeOf(e, c.prototype) : e.type === "comment" ? Object.setPrototypeOf(e, r.prototype) : e.type === "root" && Object.setPrototypeOf(e, f.prototype), e[h] = true, e.nodes && e.nodes.forEach((u2) => {
      s.rebuild(u2);
    });
  };
});
...
var ht = u((m, d) => {
  ...
  d.exports = function(h) {
    o[h] || (o[h] = true, typeof console < "u" && console.warn && console.warn(h));
  };
});
var ct = u((m, d) => {
  var o = class {
...
`.charCodeAt(0), n = " ".charCodeAt(0), g = "\f".charCodeAt(0), l = "	".charCodeAt(0), f = "\r".charCodeAt(0), t = "[".charCodeAt(0), p = "]".charCodeAt(0), s = "(".charCodeAt(0), e = ")".charCodeAt(0), u2 = "{".charCodeAt(0), a = "}".charCodeAt(0), y = ";".charCodeAt(0), w = "*".charCodeAt(0), x = ":".charCodeAt(0), k = "@".charCodeAt(0), b = /[\t\n\f\r "#'()/;[\\\]{}]/g, v2 = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, C = /.[\n"'(/\\]/, A = /[\da-f]/i;
  d.exports = function(F, M = {}) {
    ...
    function Oe(V) {
      ...
      if (O >= Y)
        return;
      let X = V ? V.ignoreUnclosed : false;
      switch (I = E.charCodeAt(O), I) {
        ...
        case g: {
          S = O;
          do
            S += 1, I = E.charCodeAt(S);
          while (I === n || I === i || I === l || I === f || I === g);
          z = ["space", E.slice(O, S)], O = S - 1;
          break;
        }
        case t:
        case p:
        ...
        case s: {
          if (N = K.length ? K.pop()[1] : "", j = E.charCodeAt(O + 1), N === "url" && j !== o && j !== h && j !== n && j !== i && j !== l && j !== g && j !== f) {
            S = O;
            do {
              if ($ = false, S = E.indexOf(")", S + 1), S === -1)
                if (T || X) {
                  S = O;
                  break;
                } else
                  Q("bracket");
              for (P = S; E.charCodeAt(P - 1) === c; )
                P -= 1, $ = !$;
            } while ($);
            z = ["brackets", E.slice(O, S + 1), O, S], O = S;
          } else
            S = E.indexOf(")", O + 1), B = E.slice(O, S + 1), S === -1 || C.test(B) ? z = ["(", "(", O] : (z = ["brackets", B, O, S], O = S);
          break;
        }
        case o:
        case h: {
          G = I === o ? "'" : '"', S = O;
          do {
            if ($ = false, S = E.indexOf(G, S + 1), S === -1)
              if (T || X) {
                S = O + 1;
                break;
              } else
          ...
          z = ["string", E.slice(O, S + 1), O, S], O = S;
          break;
        }
        case k: {
          b.lastIndex = O + 1, b.test(E), b.lastIndex === 0 ? S = E.length - 1 : S = b.lastIndex - 2, z = ["at-word", E.slice(O, S + 1), O, S], O = S;
          break;
        }
        case c: {
          for (S = O, L = true; E.charCodeAt(S + 1) === c; )
            S += 1, L = !L;
          if (I = E.charCodeAt(S + 1), L && I !== r && I !== n && I !== i && I !== l && I !== f && I !== g && (S += 1, A.test(E.charAt(S)))) {
            for (; A.test(E.charAt(S + 1)); )
              S += 1;
            E.charCodeAt(S + 1) === n && (S += 1);
          }
          z = ["word", E.slice(O, S + 1), O, S], O = S;
          break;
        }
        default: {
          I === r && E.charCodeAt(O + 1) === w ? (S = E.indexOf("*/", O + 2) + 1, S === 0 && (T || X ? S = E.length : Q("comment")), z = ["comment", E.slice(O, S + 1), O, S], O = S) : (v2.lastIndex = O + 1, v2.test(E), v2.lastIndex === 0 ? S = E.length - 1 : S = v2.lastIndex - 2, z = ["word", E.slice(O, S + 1), O, S], K.push(z), O = S);
          break;
        }
      }
      return O++, z;
    ...
    return { back: Ae, nextToken: Oe, endOfFile: Se, position: Ce };
  };
});
var Le = u((m, d) => {
...
var ft = u((m, d) => {
  var o = { split(h, c, r) {
    let i = [], n = "", g = false, l = 0, f = false, t = "", p = false;
    for (let s of h)
      p ? p = false : s === "\\" ? p = true : f ? s === t && (f = false) : s === '"' || s === "'" ? (f = true, t = s) : s === "(" ? l += 1 : s === ")" ? l > 0 && (l -= 1) : l === 0 && c.includes(s) && (g = true), g ? (n !== "" && i.push(n.trim()), n = "", g = false) : n += s;
...
var Nt = u((m, d) => {
  var o = be(), h = jt(), c = xe(), r = Le(), i = le(), n = _e(), g = { empty: true, space: true };
  function l(t) {
  ...
  var f = class {
    constructor(t) {
      this.input = t, this.root = new i(), this.current = this.root, this.spaces = "", this.semicolon = false, this.customProperty = false, this.createTokenizer(), this.root.source = { input: t, start: { offset: 0, line: 1, column: 1 } };
    }
    createTokenizer() {
    ...
    comment(t) {
      ...
      let s = t[1].slice(2, -2);
      if (/^\s*$/.test(s))
        p.text = "", p.raws.left = s, p.raws.right = "";
      else {
        let e = s.match(/^(\s*)([^]*\S)(\s*)$/);
    ...
    other(t) {
      let p = false, s = null, e = false, u2 = null, a = [], y = t[1].startsWith("--"), w = [], x = t;
      for (; x; ) {
        if (s = x[0], w.push(x), s === "(" || s === "[")
          u2 || (u2 = x), a.push(s === "(" ? ")" : "]");
        else if (y && e && s === "{")
          u2 || (u2 = x), a.push("}");
        else if (a.length === 0)
          if (s === ";")
            ...
            this.tokenizer.back(w.pop()), p = true;
            break;
          } else
            s === ":" && (e = true);
        else
          s === a[a.length - 1] && (a.pop(), a.length === 0 && (u2 = null));
        x = this.tokenizer.nextToken();
      }
      if (this.tokenizer.endOfFile() && (p = true), a.length > 0 && this.unclosedBracket(u2), p && e) {
        if (!y)
          for (; w.length && (x = w[w.length - 1][0], !(x !== "space" && x !== "comment")); )
            this.tokenizer.back(w.pop());
        this.decl(w, y);
      } else
        this.unknownWord(w);
    }
    ...
    decl(t, p) {
      ...
      this.init(s, t[0][2]);
      let e = t[t.length - 1];
      for (e[0] === ";" && (this.semicolon = true, t.pop()), s.source.end = this.getPosition(e[3] || e[2] || l(t)); t[0][0] !== "word"; )
      ...
      for (; t.length; )
        if (u2 = t.shift(), u2[0] === ":") {
          ...
          u2[0] === "word" && /\w/.test(u2[1]) && this.unknownWord([u2]), s.raws.between += u2[1];
      ...
      for (let w = t.length - 1; w >= 0; w--) {
        if (u2 = t[w], u2[1].toLowerCase() === "!important") {
          s.important = true;
          let x = this.stringFrom(t, w);
          x = this.spacesFromEnd(t) + x, x !== " !important" && (s.raws.important = x);
          break;
        } else if (u2[1].toLowerCase() === "important") {
          let x = t.slice(0), k = "";
          for (let b = w; b > 0; b--) {
            let v2 = x[b][0];
            if (k.trim().indexOf("!") === 0 && v2 !== "space")
              break;
            k = x.pop()[1] + k;
          }
          k.trim().indexOf("!") === 0 && (s.important = true, s.raws.important = k, t = x);
        }
        if (u2[0] !== "space" && u2[0] !== "comment")
          break;
      }
    ...
    atrule(t) {
      ...
      for (; !this.tokenizer.endOfFile(); ) {
        if (t = this.tokenizer.nextToken(), s = t[0], s === "(" || s === "[" ? x.push(s === "(" ? ")" : "]") : s === "{" && x.length > 0 ? x.push("}") : s === x[x.length - 1] && x.pop(), x.length === 0)
          if (s === ";") {
            ...
            if (w.length > 0) {
              for (u2 = w.length - 1, e = w[u2]; e && e[0] === "space"; )
                e = w[--u2];
      ...
      this.current.nodes && this.current.nodes.length && (this.current.raws.semicolon = this.semicolon), this.semicolon = false, this.current.raws.after = (this.current.raws.after || "") + this.spaces, this.spaces = "", this.current.parent ? (this.current.source.end = this.getPosition(t[2]), this.current = this.current.parent) : this.unexpectedClose(t);
    }
    endFile() {
    ...
    getPosition(t) {
      ...
      return { offset: t, line: p.line, column: p.col };
    }
    init(t, p) {
      this.current.push(t), t.source = { start: this.getPosition(p), input: this.input }, t.raws.before = this.spaces, this.spaces = "", t.type !== "comment" && (this.semicolon = false);
    }
    raw(t, p, s, e) {
      let u2, a, y = s.length, w = "", x = true, k, b;
      for (let v2 = 0; v2 < y; v2 += 1)
        u2 = s[v2], a = u2[0], a === "space" && v2 === y - 1 && !e ? x = false : a === "comment" ? (b = s[v2 - 1] ? s[v2 - 1][0] : "empty", k = s[v2 + 1] ? s[v2 + 1][0] : "empty", !g[b] && !g[k] ? w.slice(-1) === "," ? x = false : w += u2[1] : x = false) : w += u2[1];
      if (!x) {
        let v2 = s.reduce((C, A) => C + A[1], "");
        t.raws[p] = { value: w, raw: v2 };
      }
      t[p] = w;
    }
    spacesAndCommentsFromEnd(t) {
      let p, s = "";
      for (; t.length && (p = t[t.length - 1][0], !(p !== "space" && p !== "comment")); )
        s = t.pop()[1] + s;
      return s;
    }
    spacesAndCommentsFromStart(t) {
      let p, s = "";
      for (; t.length && (p = t[0][0], !(p !== "space" && p !== "comment")); )
        s += t.shift()[1];
      return s;
    }
    spacesFromEnd(t) {
      let p, s = "";
      for (; t.length && (p = t[t.length - 1][0], p === "space"); )
        s = t.pop()[1] + s;
      return s;
    }
    stringFrom(t, p) {
      let s = "";
      for (let e = p; e < t.length; e++)
        s += t[e][1];
    ...
    unknownWord(t) {
      throw this.input.error("Unknown word", { offset: t[0][2] }, { offset: t[0][2] + t[0][1].length });
    }
    unexpectedClose(t) {
    ...
    checkMissedSemicolon(t) {
      ...
      if (p === false)
        return;
      let s = 0, e;
      for (let u2 = p - 1; u2 >= 0 && (e = t[u2], !(e[0] !== "space" && (s += 1, s === 2))); u2--)
        ;
...
var pt = u((m, d) => {
  ...
  ht();
  var g = $e(), l = De(), f = le(), t = { document: "Document", root: "Root", atrule: "AtRule", rule: "Rule", decl: "Declaration", comment: "Comment" }, p = { postcssPlugin: true, prepare: true, Once: true, Document: true, Root: true, Declaration: true, Rule: true, AtRule: true, Comment: true, DeclarationExit: true, RuleExit: true, AtRuleExit: true, CommentExit: true, RootExit: true, DocumentExit: true, OnceExit: true }, s = { postcssPlugin: true, prepare: true, Once: true }, e = 0;
  function u2(b) {
    return typeof b == "object" && typeof b.then == "function";
  }
  function a(b) {
    let v2 = false, C = t[b.type];
    return b.type === "decl" ? v2 = b.prop.toLowerCase() : b.type === "atrule" && (v2 = b.name.toLowerCase()), v2 && b.append ? [C, C + "-" + v2, e, C + "Exit", C + "Exit-" + v2] : v2 ? [C, C + "-" + v2, C + "Exit", C + "Exit-" + v2] : b.append ? [C, e, C + "Exit"] : [C, C + "Exit"];
  }
  function y(b) {
    let v2;
    return b.type === "document" ? v2 = ["Document", e, "DocumentExit"] : b.type === "root" ? v2 = ["Root", e, "RootExit"] : v2 = a(b), { node: b, events: v2, eventIndex: 0, visitors: [], visitorIndex: 0, iterator: 0 };
  }
  function w(b) {
    return b[o] = false, b.nodes && b.nodes.forEach((v2) => w(v2)), b;
  }
  var x = {}, k = class {
    constructor(b, v2, C) {
      this.stringified = false, this.processed = false;
      let A;
      if (typeof v2 == "object" && v2 !== null && (v2.type === "root" || v2.type === "document"))
        A = w(v2);
      else if (v2 instanceof k || v2 instanceof g)
        A = w(v2.root), v2.map && (typeof C.map > "u" && (C.map = {}), C.map.inline || (C.map.inline = false), C.map.prev = v2.map);
      else {
        let F = l;
        ...
        try {
          ...
          this.processed = true, this.error = M;
        }
        A && !A[h] && i.rebuild(A);
      }
      this.result = new g(b, A, C), this.helpers = { ...x, result: this.result, postcss: x }, this.plugins = this.processor.plugins.map((F) => typeof F == "object" && F.prepare ? { ...F, ...F.prepare(this.result) } : F);
    }
    ...
    sync() {
      ...
      if (this.prepareVisitors(), this.hasListener) {
        ...
        for (; !b[o]; )
          b[o] = true, this.walkSync(b);
        if (this.listeners.OnceExit)
          if (b.type === "document")
            for (let v2 of b.nodes)
              this.visitSync(this.listeners.OnceExit, v2);
          else
    ...
    stringify() {
      ...
      let b = this.result.opts, v2 = r;
      b.syntax && (v2 = b.syntax.stringify), b.stringifier && (v2 = b.stringifier), v2.stringify && (v2 = v2.stringify);
      let C = new c(v2, this.result.root, this.result.opts).generate();
    ...
    walkSync(b) {
      ...
      for (let C of v2)
        if (C === e)
          ...
          if (A && this.visitSync(A, b.toProxy()))
            return;
        }
    }
    visitSync(b, v2) {
      for (let [C, A] of b) {
        ...
        try {
          ...
          throw this.handleError(M, v2.proxyOf);
        }
        if (v2.type !== "root" && v2.type !== "document" && !v2.parent)
          return true;
        if (u2(F))
          throw this.getAsyncError();
      }
      ...
      try {
        if (typeof b == "object" && b.Once) {
          if (this.result.root.type === "document") {
            let v2 = this.result.root.nodes.map((C) => b.Once(C, this.helpers));
            return u2(v2[0]) ? Promise.all(v2) : v2;
          }
          return b.Once(this.result.root, this.helpers);
        } else if (typeof b == "function")
          return b(this.result.root, this.result);
      } catch (v2) {
        throw this.handleError(v2);
      }
    }
    getAsyncError() {
    ...
    handleError(b, v2) {
      ...
      try {
        v2 && v2.addToError(b), this.error = b, b.name === "CssSyntaxError" && !b.plugin ? (b.plugin = C.postcssPlugin, b.setMessage()) : C.postcssVersion;
      } catch (A) {
    ...
    async runAsync() {
      ...
      for (let b = 0; b < this.plugins.length; b++) {
        let v2 = this.plugins[b], C = this.runOnRoot(v2);
        if (u2(C))
          try {
            await C;
          } catch (A) {
      ...
      if (this.prepareVisitors(), this.hasListener) {
        ...
        for (; !b[o]; ) {
          ...
          let v2 = [y(b)];
          for (; v2.length > 0; ) {
            let C = this.visitTick(v2);
            if (u2(C))
              try {
                await C;
              } catch (A) {
                let F = v2[v2.length - 1].node;
                throw this.handleError(A, F);
              }
          }
        }
        if (this.listeners.OnceExit)
          for (let [v2, C] of this.listeners.OnceExit) {
            this.result.lastPlugin = v2;
            try {
              if (b.type === "document") {
                let A = b.nodes.map((F) => C(F, this.helpers));
                await Promise.all(A);
              } else
                await C(b, this.helpers);
            } catch (A) {
              throw this.handleError(A);
            }
          }
    ...
    prepareVisitors() {
      this.listeners = {};
      let b = (v2, C, A) => {
        this.listeners[C] || (this.listeners[C] = []), this.listeners[C].push([v2, A]);
      };
      for (let v2 of this.plugins)
        if (typeof v2 == "object")
          for (let C in v2) {
            if (!p[C] && /^[A-Z]/.test(C))
              throw new Error(`Unknown event ${C} in ${v2.postcssPlugin}. Try to update PostCSS (${this.processor.version} now).`);
            if (!s[C])
              if (typeof v2[C] == "object")
                for (let A in v2[C])
                  A === "*" ? b(v2, C, v2[C][A]) : b(v2, C + "-" + A.toLowerCase(), v2[C][A]);
              else
                typeof v2[C] == "function" && b(v2, C, v2[C]);
          }
      this.hasListener = Object.keys(this.listeners).length > 0;
    }
    visitTick(b) {
      let v2 = b[b.length - 1], { node: C, visitors: A } = v2;
      if (C.type !== "root" && C.type !== "document" && !C.parent) {
        b.pop();
        return;
      }
      if (A.length > 0 && v2.visitorIndex < A.length) {
        let [M, E] = A[v2.visitorIndex];
        v2.visitorIndex += 1, v2.visitorIndex === A.length && (v2.visitors = [], v2.visitorIndex = 0), this.result.lastPlugin = M;
        try {
      ...
      if (v2.iterator !== 0) {
        let M = v2.iterator, E;
        for (; E = C.nodes[C.indexes[M]]; )
          if (C.indexes[M] += 1, !E[o]) {
            E[o] = true, b.push(y(E));
            return;
          }
        v2.iterator = 0, delete C.indexes[M];
      }
      let F = v2.events;
      for (; v2.eventIndex < F.length; ) {
        let M = F[v2.eventIndex];
        if (v2.eventIndex += 1, M === e) {
          C.nodes && C.nodes.length && (C[o] = true, v2.iterator = C.getIterator());
          return;
        } else if (this.listeners[M]) {
          v2.visitors = this.listeners[M];
          return;
        }
      }
      b.pop();
...
var zt = u((m, d) => {
  ...
  var c = De(), r = $e(), i = class {
    constructor(n, g, l) {
      g = g.toString(), this.stringified = false, this._processor = n, this._css = g, this._opts = l, this._map = void 0;
      let f, t = h;
      ...
      if (s.isMap()) {
        let [e, u2] = s.generate();
        e && (this.result.css = e), u2 && (this.result.map = u2);
      }
    }
    get [Symbol.toStringTag]() {
      return "NoWorkResult";
...
var Tt = u((m, d) => {
  var o = zt(), h = pt(), c = Be(), r = le(), i = class {
    ...
    normalize(n) {
      let g = [];
      for (let l of n)
        if (l.postcss === true ? l = l() : l.postcss && (l = l.postcss), typeof l == "object" && Array.isArray(l.plugins))
          g = g.concat(l.plugins);
...
var Ut = u((m, d) => {
  ...
  function l(f, t) {
    ...
    if (p) {
      t = [];
      for (let e of p) {
        let u2 = { ...e, __proto__: i.prototype };
        u2.map && (u2.map = { ...u2.map, __proto__: h.prototype }), t.push(u2);
      }
    }
    if (s.nodes && (s.nodes = f.nodes.map((e) => l(e, t))), s.source) {
      let { inputId: e, ...u2 } = s.source;
      s.source = u2, e != null && (s.source.input = t[e]);
    }
    if (s.type === "root")
      return new n(s);
    if (s.type === "decl")
...
var Bt = u((m, d) => {
  var o = ze(), h = be(), c = pt(), r = ee(), i = Tt(), n = ye(), g = Ut(), l = Be(), f = ct(), t = xe(), p = Le(), s = $e(), e = ve(), u2 = De(), a = ft(), y = _e(), w = le(), x = we();
  function k(...b) {
    return b.length === 1 && Array.isArray(b[0]) && (b = b[0]), new i(b);
  }
  k.plugin = function(b, v2) {
    let C = false;
    function A(...M) {
...
var gt = u((m, d) => {
  var { SourceMapConsumer: o, SourceMapGenerator: h } = oe(), { fileURLToPath: c, pathToFileURL: r } = Ue(), { resolve: i, isAbsolute: n } = ae(), { nanoid: g } = ot(), l = dt(), f = mt(), t = $t(), p = Symbol("fromOffsetCache"), s = !!(o && h), e = !!(i && n), u2 = class {
    constructor(a, y = {}) {
      if (a === null || typeof a > "u" || typeof a == "object" && !a.toString)
        throw new Error(`PostCSS received ${a} instead of CSS string`);
      if (this.css = a.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = true, this.css = this.css.slice(1)) : this.hasBOM = false, y.from && (!e || /^\w+:\/\//.test(y.from) || n(y.from) ? this.file = y.from : this.file = i(y.from)), e && s) {
...
var qt = u((m, d) => {
  var o = wt(), h = bt(), c = Ve(), r = _t(), i = Dt(), n = Vt(), g = { empty: true, space: true };
  function l(t) {
    for (let p = t.length - 1; p >= 0; p--) {
      let s = t[p], e = s[3] || s[2];
      if (e)
...
var Z = u((m, d) => {
  ...
  o.prototype.walkType = function(c, r) {
    ...
    return this.walk((n, g) => {
      if (i && n instanceof c || !i && n.type === c)
        return r.call(this, n, g);
    });
  }, d.exports = { registerWalker: h };
});
var ce = u((m, d) => {
  var o = We();
...
var Jt = u((m, d) => {
  var o = Ve(), { stringify: h } = ce(), c = /(\/\/)/, r = class extends o {
    ...
    static tokenizeNext(i, n) {
      let [g] = i, l = i.findIndex((u2) => /\n/.test(u2[1])), f = i, t = [];
      l >= 0 && (f = i.slice(0, l), t = i.slice(l)), f = f.map((u2) => u2[1]);
      let p = f.concat("~~").join(""), s = f[f.length - 1], e = ["comment", p, g[2], g[3], s[2], s[3]];
      n.back([e, ...t]);
    }
    static tokenizeInline(i, n) {
      let [g, ...l] = i, f = g[1].split(/(\/\/.+)/).filter((a) => !!a), t = [], [, , p, , s] = g, [, , , e, , u2] = g;
      for (let a of f) {
        let y = a.slice(0, 2) === "//", w = y ? "comment" : "word";
        y && (a += "~~"), a !== f[0] && (e = u2 + 1), u2 = e + a.length - 1, t.push([w, a, p, e, s, u2]);
      }
      n.back(t.concat(l));
    }
    toString(i = h) {
...
var xt = u((m, d) => {
  var o = gt(), h = bt(), c = ["*", "-", "%", "+", "/"], r = /([*/])/g, i = (t, p) => {
    let [, , s, e, u2, a] = t, y = t[1].slice(1, t[1].length - 1), w = g(y);
    for (let k of w)
      if (k[0] !== "space") {
        let b = k[5] - k[3];
        k[2] = s, k[3] += e, k[4] += u2 - 1, k[5] = k[3] + b;
      }
    let x = [["(", "(", s, e, s, e], ...w];
    x.push([")", ")", s, a, u2, a]);
    for (let k of x.reverse())
      p.back(k);
  }, n = (t, p) => {
    let s = t[1].split(/([,])/), e = [], [, , u2, , a] = t, [, , , y, , w] = t;
    for (let x of s) {
      x = x || ",";
      let k = x === "," ? "comma" : "word";
      x !== s[0] && (y = w + 1), w = y + x.length - 1, e.push([k, x, u2, y, a, w]);
    }
    for (let x of e.reverse())
      p.back(x);
  }, g = (t) => {
    ...
    let [, s, e, , u2, a] = t, y = s.split(r), [, , , w] = t, x = y.map((k) => {
      let b = [c.includes(k) ? "operator" : "word", k, e, w, u2, a];
      return w += k.length, b;
    });
    for (let k of x.reverse())
      p.back(k);
    ...
    return p.nextToken = (...e) => {
      ...
      if (!u2)
        return u2;
      let [a, y] = u2;
      return a === "brackets" ? (i(u2, p), u2 = s(...e)) : a === "word" && (c.includes(y) ? u2[0] = "operator" : r.test(y) ? (l(u2, p), u2 = s(...e)) : y.length > 1 && y.includes(",") && (n(u2, p), u2 = s(...e))), u2;
    }, p;
  };
  d.exports = { getTokens: g, tokenizer: f };
});
var kt = u((m, d) => {
...
var Ct = u((m, d) => {
  var { getTokens: o } = xt(), { registerWalker: h } = Z(), c = te(), r = class extends c {
    ...
    static tokenizeBrackets(i, n) {
      let [g, ...l] = i, f = g[1].split(/([()])/g).filter((a) => !!a), t = [], [, , p, , s] = g, [, , , e, , u2] = g;
      for (let a of f) {
        let y = a === "(" ? "(" : a === ")" ? ")" : "word";
        if (/^\s+$/.test(a) && (y = "space"), a !== f[0] && (e = u2 + 1), u2 = e + a.length - 1, y === "word") {
          let w = o(a);
          for (let x of w)
            x[3] += e - 1, t.push(x);
        } else
    ...
    static tokenizeCommas(i, n) {
      let [g, ...l] = i, f = g[1].split(/([,])/g).filter((a) => !!a), t = [], [, , p, , s] = g, [, , , e, , u2] = g;
      for (let a of f)
        a !== f[0] && (e = u2 + 1), u2 = e + a.length - 1, t.push(["word", a, p, e, s, u2]);
      n.back(t.concat(l));
    }
  };
  h(r), d.exports = r;
...
var Zt = u((m, d) => {
  var { registerWalker: o } = Z(), h = kt(), c = class extends h {
    ...
    static fromTokens(r, i) {
      let [[, , n, g]] = r, [l] = r.splice(0, 2), [, f] = l, t = new c({ prefix: f }), p = [], s = false, e, u2 = "{";
      i.init(t, n, g), i.current = t;
      for (let y of r)
        s ? p.push(y) : (y[1] === "}" && (s = true), u2 += y[1], e = y);
      s || i.unclosedBracket(l), t.params = u2;
      let a = u2.slice(1, -1);
      if (a.length) {
...
var Kt = u((m, d) => {
  var { registerWalker: o } = Z(), h = te(), c = ["+", "-", "/", "*", "%", "=", "<=", ">=", "<", ">"], r = new RegExp("([/|*}])"), i = /^[*/]\b/, n = class extends h {
    constructor(g) {
    ...
    static tokenize(g, l) {
      let [f, ...t] = g, [, p, s, , e, u2] = f, a = p.split(r).filter((x) => !!x), [, , , y] = f, w = a.map((x) => {
        let k = ["word", x, s, y, e, u2];
        return y += x.length, k;
      });
      l.back(w.concat(t));
    }
...
var ir = u((m, d) => {
  var o = tr(), h = rr(), { registerWalker: c } = Z(), r = te(), i = /^\\(.+)/, n = /^#(.+)/, g = /^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i, l = Object.keys(o), f = class extends r {
    constructor(t) {
      super(t), this.type = "word", this.isColor = false, this.isHex = false, this.isUrl = false, this.isVariable = false;
    }
    ...
    static testEscaped(t) {
      let [p, s] = t, [e, u2] = p;
      return e === "word" && (i.test(u2) || u2 === "\\" && s && !/^\s+$/.test(s[1]));
    }
    static testHex(t) {
      let [p, s] = t;
    ...
    static testVariable(t, p) {
      let [s, e] = t, { prefixes: u2 } = p.options.variables, a = new RegExp(`^(${u2.join("|")})`);
...
var sr = u((m, d) => {
  var o = qt(), h = Gt(), c = Jt(), r = Ht(), i = Zt(), n = Yt(), g = Kt(), l = Ct(), f = Xt(), t = er(), p = ir(), s = { ignoreUnknownWords: false, interpolation: false, parentNode: null, variables: { prefixes: ["--"] } };
  d.exports = class extends o {
    constructor(e, u2 = {}) {
      super(e), this.lastNode = null, this.options = Object.assign({}, s, u2), this.parentNode = this.options.parentNode;
    }
    back(e) {
      for (let u2 of e.reverse())
        this.tokenizer.back(u2);
    }
    comment(e) {
      super.comment(e);
      let u2 = c.testInline(e), a = this.lastNode;
      a.inline = u2, Object.setPrototypeOf(a, c.prototype);
    }
    fromFirst(e, u2) {
      let [a] = e, [, y, w, x] = a, k = new u2({ value: y });
      this.init(k, w, x), this.current = k, this.end(a), this.back(e.slice(1));
    }
    init(e, u2, a) {
      super.init(e, u2, a), this.lastNode = e;
    }
    other(e) {
      let u2 = [], a = [], y = e, w = null, x = null;
      for (; y; )
        [w] = y, a.push(y), w === "(" || w === "[" ? (x || (x = y), u2.push(w === "(" ? ")" : "]")) : w === u2[u2.length - 1] && (u2.pop(), u2.length === 0 && (x = null)), y = this.tokenizer.nextToken();
      u2.length > 0 && this.unclosedBracket(x), this.unknownWord(a);
    }
    parse() {
      let e;
      for (; !this.tokenizer.endOfFile(); )
    ...
    unknownWord(e) {
      let [u2] = e, [a, y] = u2;
      if (l.chars.includes(a))
        l.fromTokens(e, this);
      else if (a === "word" && g.test(e, this))
        g.fromTokens(e, this);
      else if (r.test(e))
        r.fromTokens(e, this);
      else if (this.options.interpolation && i.test(e, this))
        i.fromTokens(e, this);
      else if (a === "brackets")
        l.tokenizeBrackets(e, this);
      else if (a === "comma")
        l.fromTokens(e, this);
      else if (a === "operator")
        g.fromTokens(e, this);
...
var nr = u((m) => {
  ...
  d.stringify = function() {
    var o = { "visit_linear-gradient": function(h) {
  ...
  var d = d || {};
  d.parse = function() {
    var o = { linearGradient: /^(\-(webkit|o|ms|moz)\-)?(linear\-gradient)/i, repeatingLinearGradient: /^(\-(webkit|o|ms|moz)\-)?(repeating\-linear\-gradient)/i, radialGradient: /^(\-(webkit|o|ms|moz)\-)?(radial\-gradient)/i, repeatingRadialGradient: /^(\-(webkit|o|ms|moz)\-)?(repeating\-radial\-gradient)/i, sideOrCorner: /^to (left (top|bottom)|right (top|bottom)|left|right|top|bottom)/i, extentKeywords: /^(closest\-side|closest\-corner|farthest\-side|farthest\-corner|contain|cover)/, positionKeywords: /^(left|center|right|top|bottom)/i, pixelValue: /^(-?(([0-9]*\.[0-9]+)|([0-9]+\.?)))px/, percentageValue: /^(-?(([0-9]*\.[0-9]+)|([0-9]+\.?)))\%/, emValue: /^(-?(([0-9]*\.[0-9]+)|([0-9]+\.?)))em/, angleValue: /^(-?(([0-9]*\.[0-9]+)|([0-9]+\.?)))deg/, startCall: /^\(/, endCall: /^\)/, comma: /^,/, hexColor: /^\#([0-9a-fA-F]+)/, literalColor: /^([a-zA-Z]+)/, rgbColor: /^rgb/i, rgbaColor: /^rgba/i, number: /^(([0-9]*\.[0-9]+)|([0-9]+\.?))/ }, h = "";
    function c(P) {
      var N = new Error(h + ": " + P);
      throw N.source = h, N;
    }
    ...
    function g(P, N, j) {
      return l(N, function(z) {
        var Y = j();
        return Y && (L(o.comma) || c("Missing comma before color stops")), { type: P, orientation: Y, colorStops: b(v2) };
      });
    }
    function l(P, N) {
      var j = L(P);
    ...
    function b(P) {
      var N = P(), j = [];
      if (N)
        for (j.push(N); L(o.comma); )
          N = P(), N ? j.push(N) : c("One extra comma");
      return j;
    }
    function v2() {
      var P = C();
    ...
    function M() {
      return l(o.rgbColor, function() {
        return { type: "rgb", value: b(T) };
      });
    }
    function E() {
      return l(o.rgbaColor, function() {
        return { type: "rgba", value: b(T) };
      });
    }
    function T() {
      return L(o.number)[1];
...
function hr(m) {
  ...
  return or(m).walkRules((o) => {
    let h = Ee(lr, { selectors: [], selector: "" }, []);
    h.selectors = [...o.selectors], h.selector = o.selector, o.walkDecls((c) => {
      let r = Ee(ur, { important: c.important, property: c.prop, value: c.value });
      h.children.push(r);
    }), d.children.push(h);
  }), d;
}
var cr = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) };
var H = function(m) {
  return typeof m == "string" ? m.length > 0 : typeof m == "number";
};
var _ = function(m, d, o) {
  return d === void 0 && (d = 0), o === void 0 && (o = Math.pow(10, d)), Math.round(o * m) / o + 0;
};
var q = function(m, d, o) {
...
var Je = function(m) {
  return { r: q(m.r, 0, 255), g: q(m.g, 0, 255), b: q(m.b, 0, 255), a: q(m.a) };
};
var Re = function(m) {
  return { r: _(m.r), g: _(m.g), b: _(m.b), a: _(m.a, 3) };
};
var fr = /^#([0-9a-f]{3,8})$/i;
var pe = function(m) {
  var d = m.toString(16);
...
var Ot = function(m) {
  ...
  return { h: 60 * (n < 0 ? n + 6 : n), s: r ? i / r * 100 : 0, v: r / 255 * 100, a: c };
};
var At = function(m) {
  var d = m.h, o = m.s, h = m.v, c = m.a;
  d = d / 360 * 6, o /= 100, h /= 100;
  var r = Math.floor(d), i = h * (1 - o), n = h * (1 - (d - r) * o), g = h * (1 - (1 - d + r) * o), l = r % 6;
  return { r: 255 * [h, n, i, i, g, h][l], g: 255 * [g, h, h, n, i, i][l], b: 255 * [i, i, g, h, h, n][l], a: c };
};
var He = function(m) {
  return { h: St(m.h), s: q(m.s, 0, 100), l: q(m.l, 0, 100), a: q(m.a) };
};
var Ze = function(m) {
  return { h: _(m.h), s: _(m.s), l: _(m.l), a: _(m.a, 3) };
};
var Ye = function(m) {
  return At((o = (d = m).s, { h: d.h, s: (o *= ((h = d.l) < 50 ? h : 100 - h) / 100) > 0 ? 2 * o / (h + o) * 100 : 0, v: h + o, a: d.a }));
  var d, o, h;
};
var se = function(m) {
  return { h: (d = Ot(m)).h, s: (c = (200 - (o = d.s)) * (h = d.v) / 100) > 0 && c < 200 ? o * h / 100 / (c <= 100 ? c : 200 - c) * 100 : 0, l: c / 2, a: d.a };
  var d, o, h, c;
};
var pr = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i;
var dr = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i;
var mr = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i;
var gr = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i;
var Me = { string: [[function(m) {
  var d = fr.exec(m);
  return d ? (m = d[1]).length <= 4 ? { r: parseInt(m[0] + m[0], 16), g: parseInt(m[1] + m[1], 16), b: parseInt(m[2] + m[2], 16), a: m.length === 4 ? _(parseInt(m[3] + m[3], 16) / 255, 2) : 1 } : m.length === 6 || m.length === 8 ? { r: parseInt(m.substr(0, 2), 16), g: parseInt(m.substr(2, 2), 16), b: parseInt(m.substr(4, 2), 16), a: m.length === 8 ? _(parseInt(m.substr(6, 2), 16) / 255, 2) : 1 } : null : null;
}, "hex"], [function(m) {
  var d = mr.exec(m) || gr.exec(m);
  return d ? d[2] !== d[4] || d[4] !== d[6] ? null : Je({ r: Number(d[1]) / (d[2] ? 100 / 255 : 1), g: Number(d[3]) / (d[4] ? 100 / 255 : 1), b: Number(d[5]) / (d[6] ? 100 / 255 : 1), a: d[7] === void 0 ? 1 : Number(d[7]) / (d[8] ? 100 : 1) }) : null;
}, "rgb"], [function(m) {
  var d = pr.exec(m) || dr.exec(m);
  if (!d)
    return null;
  var o, h, c = He({ h: (o = d[1], h = d[2], h === void 0 && (h = "deg"), Number(o) * (cr[h] || 1)), s: Number(d[3]), l: Number(d[4]), a: d[5] === void 0 ? 1 : Number(d[5]) / (d[6] ? 100 : 1) });
  return Ye(c);
}, "hsl"]], object: [[function(m) {
  var d = m.r, o = m.g, h = m.b, c = m.a, r = c === void 0 ? 1 : c;
  return H(d) && H(o) && H(h) ? Je({ r: Number(d), g: Number(o), b: Number(h), a: Number(r) }) : null;
}, "rgb"], [function(m) {
  var d = m.h, o = m.s, h = m.l, c = m.a, r = c === void 0 ? 1 : c;
  if (!H(d) || !H(o) || !H(h))
    return null;
  var i = He({ h: Number(d), s: Number(o), l: Number(h), a: Number(r) });
  return Ye(i);
}, "hsl"], [function(m) {
  ...
  if (!H(d) || !H(o) || !H(h))
    return null;
  var i = function(n) {
    return { h: St(n.h), s: q(n.s, 0, 100), v: q(n.v, 0, 100), a: q(n.a) };
  }({ h: Number(d), s: Number(o), v: Number(h), a: Number(r) });
  return At(i);
}, "hsv"]] };
var Ke = function(m, d) {
...
var yr = function(m) {
  return typeof m == "string" ? Ke(m.trim(), Me.string) : typeof m == "object" && m !== null ? Ke(m, Me.object) : [null, void 0];
};
var Pe = function(m, d) {
  var o = se(m);
  return { h: o.h, s: q(o.s + 100 * d, 0, 100), l: o.l, a: o.a };
};
var Fe = function(m) {
...
var Qe = function(m, d) {
  var o = se(m);
  return { h: o.h, s: o.s, l: q(o.l + 100 * d, 0, 100), a: o.a };
};
var je = function() {
  function m(d) {
    this.parsed = yr(d)[0], this.rgba = this.parsed || { r: 0, g: 0, b: 0, a: 1 };
  }
  return m.prototype.isValid = function() {
    ...
    return d = Ot(this.rgba), { h: _(d.h), s: _(d.s), v: _(d.v), a: _(d.a, 3) };
    var d;
  }, m.prototype.invert = function() {
    return W({ r: 255 - (d = this.rgba).r, g: 255 - d.g, b: 255 - d.b, a: d.a });
    var d;
  }, m.prototype.saturate = function(d) {
    return d === void 0 && (d = 0.1), W(Pe(this.rgba, d));
  }, m.prototype.desaturate = function(d) {
    return d === void 0 && (d = 0.1), W(Pe(this.rgba, -d));
  }, m.prototype.grayscale = function() {
    return W(Pe(this.rgba, -1));
  }, m.prototype.lighten = function(d) {
    return d === void 0 && (d = 0.1), W(Qe(this.rgba, d));
    ...
    return typeof d == "number" ? W({ r: (o = this.rgba).r, g: o.g, b: o.b, a: d }) : _(this.rgba.a, 3);
    var o;
  }, m.prototype.hue = function(d) {
    var o = se(this.rgba);
    return typeof d == "number" ? W({ h: d, s: o.s, l: o.l, a: o.a }) : _(o.h);
...
function Rt(m, d) {
  ...
  m.prototype.toName = function(i) {
    ...
    if (l)
      return l;
    if (i == null ? void 0 : i.closest) {
      var f = this.toRgb(), t = 1 / 0, p = "black";
      if (!r.length)
        for (var s in o)
          r[s] = new m(o[s]).toRgb();
      for (var e in o) {
        var u2 = (n = f, g = r[e], Math.pow(n.r - g.r, 2) + Math.pow(n.g - g.g, 2) + Math.pow(n.b - g.b, 2));
        u2 < t && (t = u2, p = e);
      }
      return p;
    }
  }, d.string.push([function(i) {
    var n = i.toLowerCase(), g = n === "transparent" ? "#0000" : o[n];
    return g ? new m(g).toRgb() : null;
  }, "name"]);
}
var me = { attribute: /\[\s*(?:(?<namespace>\*|[-\w\P{ASCII}]*)\|)?(?<name>[-\w\P{ASCII}]+)\s*(?:(?<operator>\W?=)\s*(?<value>.+?)\s*(\s(?<caseSensitive>[iIsS]))?\s*)?\]/gu, id: /#(?<name>[-\w\P{ASCII}]+)/gu, class: /\.(?<name>[-\w\P{ASCII}]+)/gu, comma: /\s*,\s*/g, combinator: /\s*[\s>+~]\s*/g, "pseudo-element": /::(?<name>[-\w\P{ASCII}]+)(?:\((?<argument>¶*)\))?/gu, "pseudo-class": /:(?<name>[-\w\P{ASCII}]+)(?:\((?<argument>¶*)\))?/gu, universal: /(?:(?<namespace>\*|[-\w\P{ASCII}]*)\|)?\*/gu, type: /(?:(?<namespace>\*|[-\w\P{ASCII}]*)\|)?(?<name>[-\w\P{ASCII}]+)/gu };
var wr = /* @__PURE__ */ new Set(["combinator", "comma"]);
var br = /* @__PURE__ */ new Set(["not", "is", "where", "has", "matches", "-moz-any", "-webkit-any", "nth-child", "nth-last-child"]);
var et = /(?<index>[\dn+-]+)\s+of\s+(?<subtree>.+)/;
var vr = { "nth-child": et, "nth-last-child": et };
var xr = (m) => {
  switch (m) {
    case "pseudo-element":
    case "pseudo-class":
      return new RegExp(me[m].source.replace("(?<argument>¶*)", "(?<argument>.*)"), "gu");
    default:
      return me[m];
  }
};
...
function Cr(m, d = me) {
  ...
  for (let [c, r] of Object.entries(d))
    for (let i = 0; i < o.length; i++) {
      ...
      p && f.push(p), f.push({ ...g.groups, type: c, content: t });
  ...
  for (let c of o)
    switch (typeof c) {
      ...
      case "object":
        h += c.content.length, c.pos = [h - c.content.length, h], wr.has(c.type) && (c.content = c.content.trim() || " ");
        break;
    }
  return o;
}
...
function Ar(m, d = me) {
  if (m = m.trim(), m === "")
    return [];
  let o = [];
  m = m.replace(Or, (r, i) => (o.push({ value: r, offset: i }), "".repeat(r.length))), m = m.replace(Sr, (r, i, n, g) => (o.push({ value: r, offset: g }), `${i}${"".repeat(n.length)}${i}`));
  {
    let r = 0, i;
    for (; (i = m.indexOf("(", r)) > -1; ) {
      let n = kr(m, i);
      o.push({ value: n, offset: i }), m = `${m.substring(0, i)}(${"¶".repeat(n.length - 2)})${m.substring(i + n.length)}`, r = i + n.length;
    }
  }
  let h = Cr(m, d), c = /* @__PURE__ */ new Set();
  for (let r of o.reverse())
    for (let i of h) {
      let { offset: n, value: g } = r;
      if (!(i.pos[0] <= n && n + g.length <= i.pos[1]))
        continue;
  ...
  for (let r of c) {
    ...
    if (!n)
      throw new Error(`Unable to parse content for ${r.type}: ${r.content}`);
    Object.assign(r, n.groups);
  }
  return h;
}
function ie(m, { list: d = true } = {}) {
  if (d && m.find((o) => o.type === "comma")) {
    let o = [], h = [];
    for (let c = 0; c < m.length; c++)
      if (m[c].type === "comma") {
        if (h.length === 0)
          throw new Error("Incorrect comma at " + c);
        o.push(ie(h, { list: false })), h.length = 0;
      } else
        h.push(m[c]);
    if (h.length === 0)
      throw new Error("Trailing comma");
    return o.push(ie(h, { list: false })), { type: "list", list: o };
  }
  for (let o = m.length - 1; o >= 0; o--) {
    let h = m[o];
    if (h.type === "combinator") {
      let c = m.slice(0, o), r = m.slice(o + 1);
      return { type: "complex", combinator: h.content, left: ie(c), right: ie(r) };
    }
  }
  switch (m.length) {
    case 0:
...
function Er(m, d, o) {
  if (m)
    for (let [h, c] of ne(m, o))
      d(h, c);
}
function Pt(m, { recursive: d = true, list: o = true } = {}) {
  let h = Ar(m);
  if (!h)
    return;
  let c = ie(h, { list: o });
  if (!d)
    return c;
  for (let [r] of ne(c)) {
    if (r.type !== "pseudo-class" || !r.argument || !br.has(r.name))
      continue;
    ...
    i && Object.assign(r, { subtree: Pt(i, { recursive: true, list: true }) });
  }
  return c;
}
var Rr = v(qe(), 1);
var Ft = function(m) {
  ...
  if (typeof m == "string")
    return Ir(m);
  if (typeof m == "object")
    return Array.isArray(m) ? Pr(m) : Fr(m);
...
var Nr = function(m, d, o, h) {
  ...
  function i(n, g, l) {
    ...
    if (typeof f.type == "string") {
      ...
      Object.defineProperty(t, "name", { value: "node (" + (n.type + (p ? "<" + p + ">" : "")) + ")" });
    }
    return t;
    function t() {
      let p = [], s, e, u2;
      if ((!d || c(n, g, l[l.length - 1] || null)) && (p = zr(o(n, l)), p[0] === ge))
        return p;
      if (n.children && p[0] !== jr)
        for (e = (h ? n.children.length : -1) + r, u2 = l.concat(n); e > -1 && e < n.children.length; ) {
          if (s = i(n.children[e], e, u2)(), s[0] === ge)
            return s;
...
function zr(m) {
  return Array.isArray(m) ? m : typeof m == "number" ? [Ne, m] : [m];
}
...
var It = (m) => {
  ...
  try {
    if (!m.startsWith("linear-gradient"))
      return false;
    let d = (0, Ge.parse)(m);
    return !(d.length === 0 || ((_a = d[0]) == null ? void 0 : _a.type) !== "linear-gradient");
  } catch {
    return false;
  }
};
var Mt = (m) => {
  var _a;
  try {
    if (!m.startsWith("radial-gradient"))
      return false;
    let d = (0, Ge.parse)(m);
    return !(d.length === 0 || ((_a = d[0]) == null ? void 0 : _a.type) !== "radial-gradient");
  } catch {
    return false;
  }
};
var tt = (m) => {
  ...
  return h == null ? void 0 : h.colorStops.forEach((c, r) => {
    var _a;
    let i = [], n = 0;
    ...
    } else if (["rgb", "rgba"].includes(c.type)) {
      let l = W({ r: Number(c.value[0]), g: Number(c.value[1]), b: Number(c.value[2]), a: c.value[3] ? Number(c.value[3]) : 1 });
      i.push(parseFloat((l.rgba.r / 255).toFixed(2)), parseFloat((l.rgba.g / 255).toFixed(2)), parseFloat((l.rgba.b / 255).toFixed(2))), n = l.rgba.a;
    }
    let g = parseFloat((r / (h.colorStops.length - 1 || 1)).toFixed(2));
    ((_a = c.length) == null ? void 0 : _a.value) && Number(c.length.value) > 0 && (g = parseFloat((Number(c.length.value) / 100).toFixed(2))), d.push(g, ...i), o.push(g, n);
  }), d.push(...o), d;
};
var rt = (m, d, o) => {
  if (!["shape-gradient-fill", "shape-gradient-stroke"].includes(m.title))
    return;
  let h = d.length / 6;
  D(m, "attribute", (c) => {
    ...
    if (c.title === "static-values" && typeof c.key == "object" && c.key.value === "k" && c.children[0]) {
      let r = c.children[0];
      r.children = d.map((i) => ({ type: "primitive", valueType: "number", value: i }));
    }
  });
};
Et([Rt]);
var de = (m, d, o, h = false) => {
  let c = /* @__PURE__ */ new Set(), r = Array.isArray(m) ? m : [m];
  for (let i of r)
    D(i, "attribute", (n, g, l) => {
      var _a;
      n.title === o && ((_a = n.children[0]) == null ? void 0 : _a.value) === d && l && l.type !== "root" && (h ? l === i && c.add(l) : c.add(l));
    });
  return Array.from(c);
};
var Tr = (m, d) => {
  ...
  for (let h of d) {
    ...
    Er(r, (i, n) => {
      ...
      if (i.type === "id")
        c = de(g, i.name, "layer-xml-id", (n == null ? void 0 : n.type) === "compound");
      else if (i.type === "class")
        c = de(g, i.name, "css-class", (n == null ? void 0 : n.type) === "compound");
      else if (i.type === "type") {
        let l = "", f = null;
        ...
        i.name === "id" ? l = "layer-xml-id" : i.name === "class" ? l = "css-class" : i.name === "name" ? l = "name" : i.name === "shape-type" ? l = "shape-type" : i.name === "layer-type" && (l = "layer-type", f = Number(i.value)), l && f && ["number", "string"].includes(typeof f) && (c = de(g, f, l, (n == null ? void 0 : n.type) === "compound"));
      }
    }), o.push(...c);
  }
  return Array.from(new Set(o));
};
var Ie = (m) => m.includes("-color");
var Ur = (m) => m === "nonzero" || m === "evenodd";
var Br = (m) => m.endsWith("%") ? parseFloat(m) : parseFloat(m) * 100;
var $r = (m) => m === "nonzero" ? 1 : 2;
var Lr = (m) => {
  try {
    new URL(m);
  } catch {
...
var Dr = (m) => {
  let d = {};
  for (let o of m)
    if (Ie(o.property) && W(o.value).isValid()) {
      let h = W(o.value).rgba, c = [h.r / 255, h.g / 255, h.b / 255, h.a];
      switch (o.property) {
        case "fill-color":
          d["fill-color"] = c;
          break;
    ...
    } else if (o.property === "stroke-width")
      d["stroke-width"] = Number(o.value);
    else if (o.property === "fill-rule" && Ur(o.value))
      d["fill-rule"] = $r(o.value);
    else if (o.property === "opacity") {
      let h = Br(o.value);
      if (Number.isNaN(h))
        continue;
      h < 0 ? d.opacity = 0 : h > 100 ? d.opacity = 100 : d.opacity = h;
    } else if (o.property === "visibility")
      d.hidden = o.value === "hidden";
...
var Wr = (m, d, o) => {
  ...
  for (let h in d)
    switch (h) {
      case "fill-color":
        let c = d[h];
        m.title === "shape-fill" ? Array.isArray(c) && D(m, "array", (r) => r.title === "color-rgba-children" && r.children.length === 4 ? (r.children = r.children.map((i, n) => ({ ...i, value: c[n] })), ge) : Ne) : m.title === "layer-solid-color" && D(m, "attribute", (r) => {
          var _a2;
          if (r.title === "hex-color" && ((_a2 = r.children[0]) == null ? void 0 : _a2.value) && (c == null ? void 0 : c.length) === 4) {
            let i = W({ r: c[0] * 255, g: c[1] * 255, b: c[2] * 255, a: c[3] }).toHex();
      ...
      case "stroke-color":
        if (m.title === "shape-stroke") {
          let r = d[h];
          Array.isArray(r) && D(m, "array", (i) => i.title === "static-values-children" && i.children.length === 4 ? (i.children = i.children.map((n, g) => ({ ...n, value: r[g] })), ge) : Ne);
        }
        break;
      case "stroke-width":
        (m.title === "shape-stroke" || m.title === "shape-gradient-stroke") && D(m, "element", (r) => {
          r.title === "stroke-width" && D(r, "attribute", (i, n, g) => {
            var _a2;
            i.title === "static-value" && ((_a2 = i.children[0]) == null ? void 0 : _a2.value) && i.children[0].valueType === "number" && (g == null ? void 0 : g.title) === "animated-value-static" && (i.children[0].value = d[h]);
          });
        });
        break;
      case "fill-rule":
        ["shape-fill", "shape-gradient-fill"].includes(m.title) && D(m, "attribute", (r) => {
          var _a2;
          r.title === "fill-rule-value" && ((_a2 = r.children[0]) == null ? void 0 : _a2.value) && (r.children[0].value = d[h]);
        });
        break;
      case "opacity":
        ["shape-stroke", "shape-fill", "shape-gradient-fill", "shape-gradient-stroke"].includes(m.title) && D(m, "element", (r) => {
          ["stroke-opacity", "opacity"].includes(r.title) && D(r, "attribute", (i, n, g) => {
            var _a2;
            i.title === "static-value" && ((_a2 = i.children[0]) == null ? void 0 : _a2.value) && i.children[0].valueType === "number" && (g == null ? void 0 : g.title) === "animated-value-static" && (i.children[0].value = d[h]);
          });
        });
      ...
      case "src":
        if (m.title === "layer-image") {
          ...
          if ((r == null ? void 0 : r.type) === "attribute") {
            let i = (_a = r.children[0]) == null ? void 0 : _a.value;
            D(o, "object", (n) => {
              n.title === "asset-image" && n.children.some((g) => {
                var _a2;
                return g.title === "id" && ((_a2 = g.children[0]) == null ? void 0 : _a2.type) === "primitive" && g.children[0].value === i;
              }) && D(n, "attribute", (g) => {
...
//# sourceMappingURL=dist-4JHQ5UB4-ADENUQD3-U4OMURE2.js.map
