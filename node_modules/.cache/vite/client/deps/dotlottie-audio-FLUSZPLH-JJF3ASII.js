...
// node_modules/@dotlottie/player-component/dist/dotlottie-audio-FLUSZPLH.mjs
var L = u((x) => {
  (function() {
    var g = function() {
      this.init();
    ...
    g.prototype = { init: function() {
      ...
      if (e = parseFloat(e), n.ctx || A(), typeof e < "u" && e >= 0 && e <= 1) {
        ...
        for (var t = 0; t < n._howls.length; t++)
          if (!n._howls[t]._webAudio)
            for (var r = n._howls[t]._getSoundIds(), s = 0; s < r.length; s++) {
      ...
      for (var t = 0; t < n._howls.length; t++)
        if (!n._howls[t]._webAudio)
          for (var r = n._howls[t]._getSoundIds(), s = 0; s < r.length; s++) {
            var d = n._howls[t]._soundById(r[s]);
            d && d._node && (d._node.muted = e ? true : d._muted);
          }
      return n;
    }, stop: function() {
        ...
        var n = function(t) {
          ...
          for (var s = 0; s < e._howls.length; s++)
            if (!e._howls[s]._webAudio)
              for (var d = e._howls[s]._getSoundIds(), a = 0; a < d.length; a++) {
          ...
          m.buffer = e._scratchBuffer, m.connect(e.ctx.destination), typeof m.start > "u" ? m.noteOn(0) : m.start(0), typeof e.ctx.resume == "function" && e.ctx.resume(), m.onended = function() {
            ...
            for (var v2 = 0; v2 < e._howls.length; v2++)
              e._howls[v2]._emit("unlock");
          };
        };
      ...
      var e = this;
      if (!(!e.ctx || typeof e.ctx.resume > "u" || !o.usingWebAudio))
    ...
    u2.prototype = { init: function(e) {
      var n = this;
      return o.ctx || A(), n._autoplay = e.autoplay || false, n._format = typeof e.format != "string" ? e.format : [e.format], n._html5 = e.html5 || false, n._muted = e.mute || false, n._loop = e.loop || false, n._pool = e.pool || 5, n._preload = typeof e.preload == "boolean" || e.preload === "metadata" ? e.preload : true, n._rate = e.rate || 1, n._sprite = e.sprite || {}, n._src = typeof e.src != "string" ? e.src : [e.src], n._volume = e.volume !== void 0 ? e.volume : 1, n._xhr = { method: e.xhr && e.xhr.method ? e.xhr.method : "GET", headers: e.xhr && e.xhr.headers ? e.xhr.headers : null, withCredentials: e.xhr && e.xhr.withCredentials ? e.xhr.withCredentials : false }, n._duration = 0, n._state = "unloaded", n._sounds = [], n._endTimers = {}, n._queue = [], n._playLock = false, n._onend = e.onend ? [{ fn: e.onend }] : [], n._onfade = e.onfade ? [{ fn: e.onfade }] : [], n._onload = e.onload ? [{ fn: e.onload }] : [], n._onloaderror = e.onloaderror ? [{ fn: e.onloaderror }] : [], n._onplayerror = e.onplayerror ? [{ fn: e.onplayerror }] : [], n._onpause = e.onpause ? [{ fn: e.onpause }] : [], n._onplay = e.onplay ? [{ fn: e.onplay }] : [], n._onstop = e.onstop ? [{ fn: e.onstop }] : [], n._onmute = e.onmute ? [{ fn: e.onmute }] : [], n._onvolume = e.onvolume ? [{ fn: e.onvolume }] : [], n._onrate = e.onrate ? [{ fn: e.onrate }] : [], n._onseek = e.onseek ? [{ fn: e.onseek }] : [], n._onunlock = e.onunlock ? [{ fn: e.onunlock }] : [], n._onresume = [], n._webAudio = o.usingWebAudio && !n._html5, typeof o.ctx < "u" && o.ctx && o.autoUnlock && o._unlockAudio(), o._howls.push(n), n._autoplay && n._queue.push({ event: "play", action: function() {
        n.play();
      ...
      return e._src = n, e._state = "loading", window.location.protocol === "https:" && n.slice(0, 5) === "http:" && (e._html5 = true, e._webAudio = false), new i(e), e._webAudio && c(e), e;
    }, play: function(e, n) {
      var t = this, r = null;
      if (typeof e == "number")
        r = e, e = null;
        ...
        if (typeof e > "u" && (e = "__default", !t._playLock)) {
          for (var s = 0, d = 0; d < t._sounds.length; d++)
            t._sounds[d]._paused && !t._sounds[d]._ended && (s++, r = t._sounds[d]._id);
          s === 1 ? e = null : r = null;
        }
      }
      ...
      if (r && !e && (e = a._sprite || "__default"), t._state !== "loaded") {
        ...
        var l = a._id;
        return t._queue.push({ event: "play", action: function() {
          t.play(l);
        } }), l;
      }
      if (r && !a._paused)
        return n || t._loadQueue("play"), a._id;
      t._webAudio && o._autoResume();
      var m = Math.max(0, a._seek > 0 ? a._seek : t._sprite[e][0] / 1e3), v2 = Math.max(0, (t._sprite[e][0] + t._sprite[e][1]) / 1e3 - m), w = v2 * 1e3 / Math.abs(a._rate), b = t._sprite[e][0] / 1e3, S = (t._sprite[e][0] + t._sprite[e][1]) / 1e3;
      a._sprite = e, a._ended = false;
      var k = function() {
        a._paused = false, a._seek = m, a._start = b, a._stop = S, a._loop = !!(a._loop || t._sprite[e][2]);
      };
      if (m >= S) {
        t._ended(a);
        return;
      ...
      if (t._webAudio) {
        var I = function() {
          t._playLock = false, k(), t._refreshBuffer(a);
          var T = a._muted || t._muted ? 0 : a._volume;
          h.gain.setValueAtTime(T, o.ctx.currentTime), a._playStart = o.ctx.currentTime, typeof h.bufferSource.start > "u" ? a._loop ? h.bufferSource.noteGrainOn(0, m, 86400) : h.bufferSource.noteGrainOn(0, m, v2) : a._loop ? h.bufferSource.start(0, m, 86400) : h.bufferSource.start(0, m, v2), w !== 1 / 0 && (t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), w)), n || setTimeout(function() {
            t._emit("play", a._id), t._loadQueue();
          }, 0);
        };
        o.state === "running" && o.ctx.state !== "interrupted" ? I() : (t._playLock = true, t.once("resume", I), t._clearTimer(a._id));
      } else {
        var H = function() {
          h.currentTime = m, h.muted = a._muted || t._muted || o._muted || h.muted, h.volume = a._volume * o.volume(), h.playbackRate = a._rate;
          try {
            var T = h.play();
            if (T && typeof Promise < "u" && (T instanceof Promise || typeof T.then == "function") ? (t._playLock = true, k(), T.then(function() {
              t._playLock = false, h._unlocked = true, n ? t._loadQueue() : t._emit("play", a._id);
            }).catch(function() {
              t._playLock = false, t._emit("playerror", a._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction."), a._ended = true, a._paused = true;
            })) : n || (t._playLock = false, k(), t._emit("play", a._id)), h.playbackRate = a._rate, h.paused) {
            ...
            e !== "__default" || a._loop ? t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), w) : (t._endTimers[a._id] = function() {
              t._ended(a), h.removeEventListener("ended", t._endTimers[a._id], false);
            }, h.addEventListener("ended", t._endTimers[a._id], false));
          } catch (B) {
        ...
        if (h.readyState >= 3 || F)
          ...
          t._playLock = true, t._state = "loading";
          var M = function() {
            t._state = "loaded", H(), h.removeEventListener(o._canPlayEvent, M, false);
          };
          h.addEventListener(o._canPlayEvent, M, false), t._clearTimer(a._id);
        }
      }
      return a._id;
    }, pause: function(e) {
      ...
      for (var t = n._getSoundIds(e), r = 0; r < t.length; r++) {
        ...
        if (s && !s._paused && (s._seek = n.seek(t[r]), s._rateSeek = 0, s._paused = true, n._stopFade(t[r]), s._node))
          if (n._webAudio) {
      ...
      if (t._state !== "loaded" || t._playLock)
        return t._queue.push({ event: "stop", action: function() {
          t.stop(e);
        } }), t;
      for (var r = t._getSoundIds(e), s = 0; s < r.length; s++) {
        t._clearTimer(r[s]);
        var d = t._soundById(r[s]);
        d && (d._seek = d._start || 0, d._rateSeek = 0, d._paused = true, d._ended = true, t._stopFade(r[s]), d._node && (t._webAudio ? d._node.bufferSource && (typeof d._node.bufferSource.stop > "u" ? d._node.bufferSource.noteOff(0) : d._node.bufferSource.stop(0), t._cleanBuffer(d._node)) : (!isNaN(d._node.duration) || d._node.duration === 1 / 0) && (d._node.currentTime = d._start || 0, d._node.pause(), d._node.duration === 1 / 0 && t._clearSound(d._node))), n || t._emit("stop", d._id));
      }
      return t;
    }, mute: function(e, n) {
      var t = this;
      if (t._state !== "loaded" || t._playLock)
        return t._queue.push({ event: "mute", action: function() {
          t.mute(e, n);
        } }), t;
      if (typeof n > "u")
        if (typeof e == "boolean")
      ...
      for (var r = t._getSoundIds(n), s = 0; s < r.length; s++) {
        var d = t._soundById(r[s]);
        d && (d._muted = e, d._interval && t._stopFade(d._id), t._webAudio && d._node ? d._node.gain.setValueAtTime(e ? 0 : d._volume, o.ctx.currentTime) : d._node && (d._node.muted = o._muted ? true : e), t._emit("mute", d._id));
      }
      return t;
    }, volume: function() {
      ...
      if (n.length === 1 || n.length === 2 && typeof n[1] > "u") {
        ...
        n.length >= 2 && (t = parseFloat(n[0]), r = parseInt(n[1], 10));
      var a;
      if (typeof t < "u" && t >= 0 && t <= 1) {
        if (e._state !== "loaded" || e._playLock)
          return e._queue.push({ event: "volume", action: function() {
            e.volume.apply(e, n);
          } }), e;
        typeof r > "u" && (e._volume = t), r = e._getSoundIds(r);
        for (var l = 0; l < r.length; l++)
          a = e._soundById(r[l]), a && (a._volume = t, n[2] || e._stopFade(r[l]), e._webAudio && a._node && !a._muted ? a._node.gain.setValueAtTime(t, o.ctx.currentTime) : a._node && !a._muted && (a._node.volume = t * o.volume()), e._emit("volume", a._id));
      } else
        return a = r ? e._soundById(r) : e._sounds[0], a ? a._volume : 0;
      return e;
    }, fade: function(e, n, t, r) {
      var s = this;
      if (s._state !== "loaded" || s._playLock)
        return s._queue.push({ event: "fade", action: function() {
          s.fade(e, n, t, r);
        } }), s;
      ...
      for (var d = s._getSoundIds(r), a = 0; a < d.length; a++) {
        ...
        if (l) {
          if (r || s._stopFade(d[a]), s._webAudio && !l._muted) {
            var m = o.ctx.currentTime, v2 = m + t / 1e3;
            l._volume = e, l._node.gain.setValueAtTime(e, m), l._node.gain.linearRampToValueAtTime(n, v2);
          }
      ...
      var a = this, l = n, m = t - n, v2 = Math.abs(m / 0.01), w = Math.max(4, v2 > 0 ? r / v2 : r), b = Date.now();
      e._fadeTo = t, e._interval = setInterval(function() {
        var S = (Date.now() - b) / r;
        b = Date.now(), l += m * S, l = Math.round(l * 100) / 100, m < 0 ? l = Math.max(t, l) : l = Math.min(t, l), a._webAudio ? e._volume = l : a.volume(l, e._id, true), d && (a._volume = l), (t < n && l <= t || t > n && l >= t) && (clearInterval(e._interval), e._interval = null, e._fadeTo = null, a.volume(t, e._id), a._emit("fade", e._id));
      }, w);
      ...
      if (n.length === 1)
        if (typeof n[0] == "boolean")
          ...
          return s = e._soundById(parseInt(n[0], 10)), s ? s._loop : false;
      else
        n.length === 2 && (t = n[0], r = parseInt(n[1], 10));
      for (var d = e._getSoundIds(r), a = 0; a < d.length; a++)
        s = e._soundById(d[a]), s && (s._loop = t, e._webAudio && s._node && s._node.bufferSource && (s._node.bufferSource.loop = t, t && (s._node.bufferSource.loopStart = s._start || 0, s._node.bufferSource.loopEnd = s._stop, e.playing(d[a]) && (e.pause(d[a], true), e.play(d[a], true)))));
      return e;
    }, rate: function() {
      var e = this, n = arguments, t, r;
      if (n.length === 0)
      ...
      if (typeof t == "number") {
        if (e._state !== "loaded" || e._playLock)
          return e._queue.push({ event: "rate", action: function() {
            e.rate.apply(e, n);
          } }), e;
        typeof r > "u" && (e._rate = t), r = e._getSoundIds(r);
        for (var l = 0; l < r.length; l++)
          if (a = e._soundById(r[l]), a) {
            ...
            var m = e.seek(r[l]), v2 = (e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) / 1e3 - m, w = v2 * 1e3 / Math.abs(a._rate);
            (e._endTimers[r[l]] || !a._paused) && (e._clearTimer(r[l]), e._endTimers[r[l]] = setTimeout(e._ended.bind(e, a), w)), e._emit("rate", a._id);
          }
      } else
        return a = e._soundById(r), a ? a._rate : e._rate;
      return e;
    }, seek: function() {
      var e = this, n = arguments, t, r;
      if (n.length === 0)
      ...
      if (typeof t == "number" && (e._state !== "loaded" || e._playLock))
        return e._queue.push({ event: "seek", action: function() {
          e.seek.apply(e, n);
        } }), e;
      ...
      if (a)
        if (typeof t == "number" && t >= 0) {
          var l = e.playing(r);
          l && e.pause(r, true), a._seek = t, a._ended = false, e._clearTimer(r), !e._webAudio && a._node && !isNaN(a._node.duration) && (a._node.currentTime = t);
          var m = function() {
            l && e.play(r, true), e._emit("seek", r);
          };
          if (l && !e._webAudio) {
            var v2 = function() {
              e._playLock ? setTimeout(v2, 0) : m();
            };
            setTimeout(v2, 0);
          } else
            m();
      ...
      for (var e = this, n = e._sounds, t = 0; t < n.length; t++)
        n[t]._paused || e.stop(n[t]._id), e._webAudio || (e._clearSound(n[t]._node), n[t]._node.removeEventListener("error", n[t]._errorFn, false), n[t]._node.removeEventListener(o._canPlayEvent, n[t]._loadFn, false), n[t]._node.removeEventListener("ended", n[t]._endFn, false), o._releaseHtml5Audio(n[t]._node)), delete n[t]._node, e._clearTimer(n[t]._id);
      var r = o._howls.indexOf(e);
      r >= 0 && o._howls.splice(r, 1);
      var s = true;
      for (t = 0; t < o._howls.length; t++)
        if (o._howls[t]._src === e._src || e._src.indexOf(o._howls[t]._src) >= 0) {
          s = false;
          break;
        }
      return p && s && delete p[e._src], o.noAudio = false, e._state = "unloaded", e._sounds = [], e = null, null;
    }, on: function(e, n, t, r) {
      var s = this, d = s["_on" + e];
      return typeof n == "function" && d.push(r ? { id: t, fn: n, once: r } : { id: t, fn: n }), s;
    }, off: function(e, n, t) {
      ...
      if (typeof n == "number" && (t = n, n = null), n || t)
        ...
        for (d = 0; d < l.length; d++)
          l[d].indexOf("_on") === 0 && Array.isArray(r[l[d]]) && (r[l[d]] = []);
      }
      return r;
    }, once: function(e, n, t) {
      var r = this;
      ...
      for (var r = this, s = r["_on" + e], d = s.length - 1; d >= 0; d--)
        (!s[d].id || s[d].id === n || e === "load") && (setTimeout((function(a) {
          a.call(this, n, t);
      ...
      if (n._endTimers[e]) {
        if (typeof n._endTimers[e] != "function")
          ...
          var t = n._soundById(e);
          t && t._node && t._node.removeEventListener("ended", n._endTimers[e], false);
        }
      ...
      var n = this;
      if (typeof e > "u") {
        for (var t = [], r = 0; r < n._sounds.length; r++)
          t.push(n._sounds[r]._id);
        return t;
      } else
        return [e];
    ...
    i.prototype = { init: function() {
      ...
      return n._webAudio ? (e._node = typeof o.ctx.createGain > "u" ? o.ctx.createGainNode() : o.ctx.createGain(), e._node.gain.setValueAtTime(t, o.ctx.currentTime), e._node.paused = true, e._node.connect(o.masterGain)) : o.noAudio || (e._node = o._obtainHtml5Audio(), e._errorFn = e._errorListener.bind(e), e._node.addEventListener("error", e._errorFn, false), e._loadFn = e._loadListener.bind(e), e._node.addEventListener(o._canPlayEvent, e._loadFn, false), e._endFn = e._endListener.bind(e), e._node.addEventListener("ended", e._endFn, false), e._node.src = n._src, e._node.preload = n._preload === true ? "auto" : n._preload, e._node.volume = t * o.volume(), e._node.load()), e;
    }, reset: function() {
      var e = this, n = e._parent;
      ...
      var e = this, n = e._parent;
      n._duration = Math.ceil(e._node.duration * 10) / 10, Object.keys(n._sprite).length === 0 && (n._sprite = { __default: [0, n._duration * 1e3] }), n._state !== "loaded" && (n._state = "loaded", n._emit("load"), n._loadQueue()), e._node.removeEventListener(o._canPlayEvent, e._loadFn, false);
    }, _endListener: function() {
      var e = this, n = e._parent;
      n._duration === 1 / 0 && (n._duration = Math.ceil(e._node.duration * 10) / 10, n._sprite.__default[1] === 1 / 0 && (n._sprite.__default[1] = n._duration * 1e3), n._ended(e)), e._node.removeEventListener("ended", e._endFn, false);
    } };
    var p = {}, c = function(e) {
      var n = e._src;
      if (p[n]) {
      ...
      if (/^data:[^;]+;base64,/.test(n)) {
        for (var t = atob(n.split(",")[1]), r = new Uint8Array(t.length), s = 0; s < t.length; ++s)
          r[s] = t.charCodeAt(s);
        f(r.buffer, e);
      } else {
        var d = new XMLHttpRequest();
        d.open(e._xhr.method, n, true), d.withCredentials = e._xhr.withCredentials, d.responseType = "arraybuffer", e._xhr.headers && Object.keys(e._xhr.headers).forEach(function(a) {
          ...
          e._webAudio && (e._html5 = true, e._webAudio = false, e._sounds = [], delete p[n], e.load());
        }, y(d);
      }
    }, y = function(e) {
      try {
    ...
    typeof define == "function" && define.amd && define([], function() {
      return { Howler: o, Howl: u2 };
    }), typeof x < "u" && (x.Howler = o, x.Howl = u2), typeof global < "u" ? (global.HowlerGlobal = g, global.Howler = o, global.Howl = u2, global.Sound = i) : typeof window < "u" && (window.HowlerGlobal = g, window.Howler = o, window.Howl = u2, window.Sound = i);
  })(), function() {
    HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(o) {
      var u2 = this;
      if (!u2.ctx || !u2.ctx.listener)
        return u2;
      for (var i = u2._howls.length - 1; i >= 0; i--)
        u2._howls[i].stereo(o);
      return u2;
    }, HowlerGlobal.prototype.pos = function(o, u2, i) {
      var p = this;
      if (!p.ctx || !p.ctx.listener)
        return p;
      if (u2 = typeof u2 != "number" ? p._pos[1] : u2, i = typeof i != "number" ? p._pos[2] : i, typeof o == "number")
        p._pos = [o, u2, i], typeof p.ctx.listener.positionX < "u" ? (p.ctx.listener.positionX.setTargetAtTime(p._pos[0], Howler.ctx.currentTime, 0.1), p.ctx.listener.positionY.setTargetAtTime(p._pos[1], Howler.ctx.currentTime, 0.1), p.ctx.listener.positionZ.setTargetAtTime(p._pos[2], Howler.ctx.currentTime, 0.1)) : p.ctx.listener.setPosition(p._pos[0], p._pos[1], p._pos[2]);
      else
        return p._pos;
      return p;
    }, HowlerGlobal.prototype.orientation = function(o, u2, i, p, c, y) {
      var f = this;
      if (!f.ctx || !f.ctx.listener)
        return f;
      var _ = f._orientation;
      if (u2 = typeof u2 != "number" ? _[1] : u2, i = typeof i != "number" ? _[2] : i, p = typeof p != "number" ? _[3] : p, c = typeof c != "number" ? _[4] : c, y = typeof y != "number" ? _[5] : y, typeof o == "number")
        f._orientation = [o, u2, i, p, c, y], typeof f.ctx.listener.forwardX < "u" ? (f.ctx.listener.forwardX.setTargetAtTime(o, Howler.ctx.currentTime, 0.1), f.ctx.listener.forwardY.setTargetAtTime(u2, Howler.ctx.currentTime, 0.1), f.ctx.listener.forwardZ.setTargetAtTime(i, Howler.ctx.currentTime, 0.1), f.ctx.listener.upX.setTargetAtTime(p, Howler.ctx.currentTime, 0.1), f.ctx.listener.upY.setTargetAtTime(c, Howler.ctx.currentTime, 0.1), f.ctx.listener.upZ.setTargetAtTime(y, Howler.ctx.currentTime, 0.1)) : f.ctx.listener.setOrientation(o, u2, i, p, c, y);
      else
        return _;
      return f;
      ...
      return function(u2) {
        var i = this;
        return i._orientation = u2.orientation || [1, 0, 0], i._stereo = u2.stereo || null, i._pos = u2.pos || null, i._pannerAttr = { coneInnerAngle: typeof u2.coneInnerAngle < "u" ? u2.coneInnerAngle : 360, coneOuterAngle: typeof u2.coneOuterAngle < "u" ? u2.coneOuterAngle : 360, coneOuterGain: typeof u2.coneOuterGain < "u" ? u2.coneOuterGain : 0, distanceModel: typeof u2.distanceModel < "u" ? u2.distanceModel : "inverse", maxDistance: typeof u2.maxDistance < "u" ? u2.maxDistance : 1e4, panningModel: typeof u2.panningModel < "u" ? u2.panningModel : "HRTF", refDistance: typeof u2.refDistance < "u" ? u2.refDistance : 1, rolloffFactor: typeof u2.rolloffFactor < "u" ? u2.rolloffFactor : 1 }, i._onstereo = u2.onstereo ? [{ fn: u2.onstereo }] : [], i._onpos = u2.onpos ? [{ fn: u2.onpos }] : [], i._onorientation = u2.onorientation ? [{ fn: u2.onorientation }] : [], o.call(this, u2);
      };
    }(Howl.prototype.init), Howl.prototype.stereo = function(o, u2) {
      var i = this;
      if (!i._webAudio)
        return i;
      if (i._state !== "loaded")
        return i._queue.push({ event: "stereo", action: function() {
          i.stereo(o, u2);
        } }), i;
      var p = typeof Howler.ctx.createStereoPanner > "u" ? "spatial" : "stereo";
      if (typeof u2 > "u")
        if (typeof o == "number")
          i._stereo = o, i._pos = [o, 0, 0];
        else
          return i._stereo;
      for (var c = i._getSoundIds(u2), y = 0; y < c.length; y++) {
        var f = i._soundById(c[y]);
        if (f)
          if (typeof o == "number")
            f._stereo = o, f._pos = [o, 0, 0], f._node && (f._pannerAttr.panningModel = "equalpower", (!f._panner || !f._panner.pan) && g(f, p), p === "spatial" ? typeof f._panner.positionX < "u" ? (f._panner.positionX.setValueAtTime(o, Howler.ctx.currentTime), f._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime), f._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : f._panner.setPosition(o, 0, 0) : f._panner.pan.setValueAtTime(o, Howler.ctx.currentTime)), i._emit("stereo", f._id);
          else
            return f._stereo;
      }
      return i;
    }, Howl.prototype.pos = function(o, u2, i, p) {
      var c = this;
      if (!c._webAudio)
        return c;
      if (c._state !== "loaded")
        return c._queue.push({ event: "pos", action: function() {
          c.pos(o, u2, i, p);
        } }), c;
      if (u2 = typeof u2 != "number" ? 0 : u2, i = typeof i != "number" ? -0.5 : i, typeof p > "u")
        if (typeof o == "number")
          c._pos = [o, u2, i];
        else
          return c._pos;
      for (var y = c._getSoundIds(p), f = 0; f < y.length; f++) {
        ...
        if (_)
          if (typeof o == "number")
            _._pos = [o, u2, i], _._node && ((!_._panner || _._panner.pan) && g(_, "spatial"), typeof _._panner.positionX < "u" ? (_._panner.positionX.setValueAtTime(o, Howler.ctx.currentTime), _._panner.positionY.setValueAtTime(u2, Howler.ctx.currentTime), _._panner.positionZ.setValueAtTime(i, Howler.ctx.currentTime)) : _._panner.setPosition(o, u2, i)), c._emit("pos", _._id);
          else
            return _._pos;
      }
      return c;
    }, Howl.prototype.orientation = function(o, u2, i, p) {
      var c = this;
      if (!c._webAudio)
        return c;
      if (c._state !== "loaded")
        return c._queue.push({ event: "orientation", action: function() {
          c.orientation(o, u2, i, p);
        } }), c;
      if (u2 = typeof u2 != "number" ? c._orientation[1] : u2, i = typeof i != "number" ? c._orientation[2] : i, typeof p > "u")
        if (typeof o == "number")
          c._orientation = [o, u2, i];
        else
      ...
      for (var y = c._getSoundIds(p), f = 0; f < y.length; f++) {
        ...
        if (_)
          if (typeof o == "number")
            _._orientation = [o, u2, i], _._node && (_._panner || (_._pos || (_._pos = c._pos || [0, 0, -0.5]), g(_, "spatial")), typeof _._panner.orientationX < "u" ? (_._panner.orientationX.setValueAtTime(o, Howler.ctx.currentTime), _._panner.orientationY.setValueAtTime(u2, Howler.ctx.currentTime), _._panner.orientationZ.setValueAtTime(i, Howler.ctx.currentTime)) : _._panner.setOrientation(o, u2, i)), c._emit("orientation", _._id);
          else
            return _._orientation;
      }
      return c;
    }, Howl.prototype.pannerAttr = function() {
      var o = this, u2 = arguments, i, p, c;
      if (!o._webAudio)
        return o;
      if (u2.length === 0)
        return o._pannerAttr;
      if (u2.length === 1)
        if (typeof u2[0] == "object")
          i = u2[0], typeof p > "u" && (i.pannerAttr || (i.pannerAttr = { coneInnerAngle: i.coneInnerAngle, coneOuterAngle: i.coneOuterAngle, coneOuterGain: i.coneOuterGain, distanceModel: i.distanceModel, maxDistance: i.maxDistance, refDistance: i.refDistance, rolloffFactor: i.rolloffFactor, panningModel: i.panningModel }), o._pannerAttr = { coneInnerAngle: typeof i.pannerAttr.coneInnerAngle < "u" ? i.pannerAttr.coneInnerAngle : o._coneInnerAngle, coneOuterAngle: typeof i.pannerAttr.coneOuterAngle < "u" ? i.pannerAttr.coneOuterAngle : o._coneOuterAngle, coneOuterGain: typeof i.pannerAttr.coneOuterGain < "u" ? i.pannerAttr.coneOuterGain : o._coneOuterGain, distanceModel: typeof i.pannerAttr.distanceModel < "u" ? i.pannerAttr.distanceModel : o._distanceModel, maxDistance: typeof i.pannerAttr.maxDistance < "u" ? i.pannerAttr.maxDistance : o._maxDistance, refDistance: typeof i.pannerAttr.refDistance < "u" ? i.pannerAttr.refDistance : o._refDistance, rolloffFactor: typeof i.pannerAttr.rolloffFactor < "u" ? i.pannerAttr.rolloffFactor : o._rolloffFactor, panningModel: typeof i.pannerAttr.panningModel < "u" ? i.pannerAttr.panningModel : o._panningModel });
        else
          return c = o._soundById(parseInt(u2[0], 10)), c ? c._pannerAttr : o._pannerAttr;
      else
        u2.length === 2 && (i = u2[0], p = parseInt(u2[1], 10));
      for (var y = o._getSoundIds(p), f = 0; f < y.length; f++)
        if (c = o._soundById(y[f]), c) {
          var _ = c._pannerAttr;
          _ = { coneInnerAngle: typeof i.coneInnerAngle < "u" ? i.coneInnerAngle : _.coneInnerAngle, coneOuterAngle: typeof i.coneOuterAngle < "u" ? i.coneOuterAngle : _.coneOuterAngle, coneOuterGain: typeof i.coneOuterGain < "u" ? i.coneOuterGain : _.coneOuterGain, distanceModel: typeof i.distanceModel < "u" ? i.distanceModel : _.distanceModel, maxDistance: typeof i.maxDistance < "u" ? i.maxDistance : _.maxDistance, refDistance: typeof i.refDistance < "u" ? i.refDistance : _.refDistance, rolloffFactor: typeof i.rolloffFactor < "u" ? i.rolloffFactor : _.rolloffFactor, panningModel: typeof i.panningModel < "u" ? i.panningModel : _.panningModel };
          var A = c._panner;
          A ? (A.coneInnerAngle = _.coneInnerAngle, A.coneOuterAngle = _.coneOuterAngle, A.coneOuterGain = _.coneOuterGain, A.distanceModel = _.distanceModel, A.maxDistance = _.maxDistance, A.refDistance = _.refDistance, A.rolloffFactor = _.rolloffFactor, A.panningModel = _.panningModel) : (c._pos || (c._pos = o._pos || [0, 0, -0.5]), g(c, "spatial"));
        }
      return o;
    }, Sound.prototype.init = function(o) {
      return function() {
        var u2 = this, i = u2._parent;
        u2._orientation = i._orientation, u2._stereo = i._stereo, u2._pos = i._pos, u2._pannerAttr = i._pannerAttr, o.call(this), u2._stereo ? i.stereo(u2._stereo) : u2._pos && i.pos(u2._pos[0], u2._pos[1], u2._pos[2], u2._id);
      };
    }(Sound.prototype.init), Sound.prototype.reset = function(o) {
      return function() {
        var u2 = this, i = u2._parent;
        return u2._orientation = i._orientation, u2._stereo = i._stereo, u2._pos = i._pos, u2._pannerAttr = i._pannerAttr, u2._stereo ? i.stereo(u2._stereo) : u2._pos ? i.pos(u2._pos[0], u2._pos[1], u2._pos[2], u2._id) : u2._panner && (u2._panner.disconnect(0), u2._panner = void 0, i._refreshBuffer(u2)), o.call(this);
      };
    }(Sound.prototype.reset);
    var g = function(o, u2) {
      u2 = u2 || "spatial", u2 === "spatial" ? (o._panner = Howler.ctx.createPanner(), o._panner.coneInnerAngle = o._pannerAttr.coneInnerAngle, o._panner.coneOuterAngle = o._pannerAttr.coneOuterAngle, o._panner.coneOuterGain = o._pannerAttr.coneOuterGain, o._panner.distanceModel = o._pannerAttr.distanceModel, o._panner.maxDistance = o._pannerAttr.maxDistance, o._panner.refDistance = o._pannerAttr.refDistance, o._panner.rolloffFactor = o._pannerAttr.rolloffFactor, o._panner.panningModel = o._pannerAttr.panningModel, typeof o._panner.positionX < "u" ? (o._panner.positionX.setValueAtTime(o._pos[0], Howler.ctx.currentTime), o._panner.positionY.setValueAtTime(o._pos[1], Howler.ctx.currentTime), o._panner.positionZ.setValueAtTime(o._pos[2], Howler.ctx.currentTime)) : o._panner.setPosition(o._pos[0], o._pos[1], o._pos[2]), typeof o._panner.orientationX < "u" ? (o._panner.orientationX.setValueAtTime(o._orientation[0], Howler.ctx.currentTime), o._panner.orientationY.setValueAtTime(o._orientation[1], Howler.ctx.currentTime), o._panner.orientationZ.setValueAtTime(o._orientation[2], Howler.ctx.currentTime)) : o._panner.setOrientation(o._orientation[0], o._orientation[1], o._orientation[2])) : (o._panner = Howler.ctx.createStereoPanner(), o._panner.pan.setValueAtTime(o._stereo, Howler.ctx.currentTime)), o._panner.connect(o._node), o._paused || o._parent.pause(o._id, true).play(o._id, true);
    };
  }();
});
var D = v(L(), 1);
...
@dotlottie/player-component/dist/dotlottie-audio-FLUSZPLH.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=dotlottie-audio-FLUSZPLH-JJF3ASII.js.map
