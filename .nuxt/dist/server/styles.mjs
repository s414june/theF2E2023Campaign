...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.77da9631.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.32018baf.mjs').then(interopDefault),
